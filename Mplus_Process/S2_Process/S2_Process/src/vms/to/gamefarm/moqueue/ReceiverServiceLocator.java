...
public class ReceiverServiceLocator extends org.apache.axis.client.Service implements vms.to.gamefarm.moqueue.ReceiverService {
    ...
    private java.lang.String Receiver_address = Constants._prop.getProperty("wsVMS2GAMEFARMMOQUEUE", "");
    ...
    public vms.to.gamefarm.moqueue.Receiver getReceiver(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            vms.to.gamefarm.moqueue.ReceiverSoapBindingStub _stub = new vms.to.gamefarm.moqueue.ReceiverSoapBindingStub(portAddress, this);
	...
	public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (vms.to.gamefarm.moqueue.Receiver.class.isAssignableFrom(serviceEndpointInterface)) {
                vms.to.gamefarm.moqueue.ReceiverSoapBindingStub _stub = new vms.to.gamefarm.moqueue.ReceiverSoapBindingStub(new java.net.URL(Receiver_address), this);
                _stub.setPortName(getReceiverWSDDServiceName());
                return _stub;
            }
        }
