...
public class ReceiverSoapBindingImpl implements vms.to.gamefarm.moqueue.Receiver{
    public int insertMOQueueICOM(java.lang.String USER_ID, java.lang.String SERVICE_ID, java.lang.String MOBILE_OPERATOR
        ...
        try {
           ...
           // locator.setReceiverEndpointAddress("");
            ...
            binding.setUsername(Constants._prop.getProperty("wsVMS2GAMEFARMMOQUEUE_UserName", ""));
            binding.setPassword(Constants._prop.getProperty("wsVMS2GAMEFARMMOQUEUE_PassWord", ""));
