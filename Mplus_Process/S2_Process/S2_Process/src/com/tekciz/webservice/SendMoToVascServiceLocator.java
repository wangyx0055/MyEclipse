...
public class SendMoToVascServiceLocator extends org.apache.axis.client.Service implements com.tekciz.webservice.SendMoToVascService {
    ...
    private java.lang.String SendMoToVasc_address = "http://10.151.190.38:8080/VMS-Mplus-Webservice/services/SendMoToVasc";
    ...
    public com.tekciz.webservice.SendMoToVasc getSendMoToVasc() throws javax.xml.rpc.ServiceException {
    ...
    public com.tekciz.webservice.SendMoToVasc getSendMoToVasc(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.tekciz.webservice.SendMoToVascSoapBindingStub _stub = new com.tekciz.webservice.SendMoToVascSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.tekciz.webservice.SendMoToVasc.class.isAssignableFrom(serviceEndpointInterface)) {
                com.tekciz.webservice.SendMoToVascSoapBindingStub _stub = new com.tekciz.webservice.SendMoToVascSoapBindingStub(new java.net.URL(SendMoToVasc_address), this);
                _stub.setPortName(getSendMoToVascWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://webservice.tekciz.com", "SendMoToVascService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://webservice.tekciz.com", "SendMoToVasc"));
        }
