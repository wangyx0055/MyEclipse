...
public class MlistInfoDTO {
	...
	public int getTotalScoreByDay() {
		return totalScoreByDay;
	}

	public void setTotalScoreByDay(int totalScoreByDay) {
		this.totalScoreByDay = totalScoreByDay;
	}

	public int getTotalScoreByWeek() {
		return totalScoreByWeek;
	}

	public void setTotalScoreByWeek(int totalScoreByWeek) {
		this.totalScoreByWeek = totalScoreByWeek;
	}
	...
	public MlistInfoDTO(MsgObject msg) {
		this.userId = msg.getUserid();
		this.serviceId = msg.getServiceid();
		this.commandCode = msg.getCommandCode();
		this.mobiOperator = msg.getMobileoperator();
		this.messageType = msg.getMsgtype();
		this.chanelType = msg.getChannelType();
		this.requestId = String.valueOf(msg.getId());
	}
