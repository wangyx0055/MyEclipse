...
public class Infodaily extends DeliveryManager {
	...
	protected Collection getMessages(String ssid, String option,
		...
		try {
			...
			{
				Util.logger.error("Infodaily: co loi khi get service");
				DBUtil
				.Alert(
						"Process.VMS",
						"Infodaily",
						"major",
						"Infodaily.Exception: co loi khi get service.ex=" + ex.toString(),"");
			}
...
//if(1==1) return "test infodali";
		...
		try {
			...
			Util.logger.info("Infodaily: sql select content : sql =" + query);
