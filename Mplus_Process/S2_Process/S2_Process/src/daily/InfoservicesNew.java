...
/**
*
* @description Response MT with content get from new CMS 
* @author DanND
*
*/
public class InfoservicesNew extends DeliveryManager {
	...
	protected Collection getMessages(String ssid, String option,
		...
		try {
			...
			System.out.println("Table Content = " + tblContent);
			...
			String strResult = getContent2(DBCONTENT, type, INFO_ID, currDate, tblContent, serviceName);
			System.out.println("Content Result = " + strResult);
			if (strResult == null) {
				return null;
			} else {
	...
	private String getContent2(String dbcontent, String type, String infoid,
		...
		try {
			...
			String query = "SELECT content"
				...
				+ " AND IsPublish=1 AND KeyWord='" + commandCode + "'";
