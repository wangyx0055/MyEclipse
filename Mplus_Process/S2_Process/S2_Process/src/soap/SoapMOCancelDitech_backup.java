...
public class SoapMOCancelDitech_backup extends QuestionManager {
	...
	protected Collection getMessages(Properties prop, MsgObject msgObject,
		...
		try {
			...
			Util.logger.info("SoapMOCancelDitech ; user_id = " + msgObject.getUserid() 
			...
			if(result.equals("1") || result.equals("2") || result.equals("0")){
				if(msgObject.getUsertext().toUpperCase().trim().equals("HUY TIN")){
					...
					if(mtPushObject != null){
						...
						Util.logger.info("SoapMOCancelDitech ## " +
			...
			if (result.equalsIgnoreCase("1")) {
				...
				Util.logger.info("@SoapMOCancelDitech@Push mo queue sang icom thanh cong!@user_id=" + msgObject.getUserid() + "@keyword=" +msgObject.getKeyword() + "@request_id=" + msgObject.getRequestid());
