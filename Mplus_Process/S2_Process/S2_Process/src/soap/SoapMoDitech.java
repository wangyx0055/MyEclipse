...
public class SoapMoDitech  extends QuestionManager{
	String className = "SoapMoDitech ";
	@Override
	protected Collection getMessages(Properties prop, MsgObject msgObject,
		...
		try{
			...
			String url = Constants._prop.getProperty("mo.soap.ditech.url");
			String sUserName = Constants._prop.getProperty("mo.soap.ditech.username");
			String sPassword = Constants._prop.getProperty("mo.soap.ditech.password");
			...
			Util.logger.info(className + " fw mo.@info :\t@sUser:"
					...
					+sInfo+"\t@requestid:"
					+iRequestId +"\t@Mobile:"
					+sOperator+"\t@iMulti:"+iMulti);
					
		 	/*int iReturn = proxy.moReceiver(sUserName, sPassword, sMsisdn, sServiceNumber, 
 					sServiceCode, sInfo, iRequestId+"", sOperator, iChannel_Type);*/
		 	int iReturn = proxy.sendMo(sUserName, sPassword, sMsisdn, sServiceNumber, sServiceCode,
		 			sInfo, iRequestId+"", sOperator, 0, iMulti);
		 	// -2 : loi he thong
			// -1 : Sai cu phap
