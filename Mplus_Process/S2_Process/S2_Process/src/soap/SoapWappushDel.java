...
public class SoapWappushDel extends QuestionManager {
	@Override
	protected Collection getMessages(Properties prop, MsgObject msgObject,
		...
		try {
			...
			if (result.equals("1")) {
				 ...
				 * ***/
				Util.logger.info("@SoapWappushDel@Push mo queue sang icom thanh cong!@user_id=" + msgObject.getUserid() + "@keyword=" +msgObject.getKeyword() + "@request_id=" + msgObject.getRequestid());
				return DBUtil.UnRegisterServices(msgObject, keyword);
			}
			int retriesnum = msgObject.getRetries_num();

			Util.logger.info(getClass().getName() + "@"
