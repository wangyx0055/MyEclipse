...
public class SoapList extends QuestionManager {
	...
	protected Collection getMessages(Properties prop, MsgObject msgObject,
		...
		try {
			...
			if (msgObject.getObjtype() == 0) {
				...
				Util.logger.info("Command_Code gui sang VASC" + commandcode);
			...
			if (result.equalsIgnoreCase("1")) {
				...
				insertData(msgObject.getUserid(), msgObject.getServiceid(),
						msgObject.getServiceid(), MLIST, msgObject, mtfree, 1,
						keyword.getService_ss_id(), duration, keyword
								.getAmount(), keyword.getService_type());

				insertSubUser(msgObject.getUserid(), msgObject.getServiceid(),
						msgObject.getServiceid(), MLIST, msgObject, mtfree, 1,
						keyword.getService_ss_id(), "1", keyword
								.getService_ss_id());
