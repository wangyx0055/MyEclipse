...
public class SoapQMKraze extends QuestionManager {
	...
	protected Collection getMessages(Properties prop, MsgObject msgObject,
		...
		try {
			...
			if (stoken.length > 2) {
				...
				msgObject.setUsertext("Sai ma so.D/sach ma so the loai "
						+ category + ":" + content + ":");
				msgObject.setMsgtype(1);
				msgObject.setContenttype(8);
				Util.logger.info("Service ID: " + msgObject.getServiceid());
