...
import MPlusServiceViq.MPlusPortProxy;
...
public class SoapMoVNPTGlobal  extends QuestionManager{
	String className = "SoapMoVietGlobal1.java ";
	@Override
	protected Collection getMessages(Properties prop, MsgObject msgObject,
		...
		try{
			...
			String url = Constants._prop.getProperty("mo.soap.VNPTGlobal.url");
			String sUserName = Constants._prop.getProperty("mo.soap.VNPTGlobal.username");
			String sPassword = Constants._prop.getProperty("mo.soap.VNPTGlobal.password");
			...
			Util.logger.info(className + " fw mo.@info :\t@sUser:"
		 	...
		 	int iReturn = proxy.moReceiver(sUserName, sPassword, sMsisdn, sServiceNumber, sServiceCode, sInfo, iRequestId, sOperator, iChannel_Type);
