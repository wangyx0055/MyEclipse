...
public class SoapMoVietTekzic  extends QuestionManager{
	String className = "SoapMoVietTekzic ";
	@Override
	protected Collection getMessages(Properties prop, MsgObject msgObject,
		...
		try{
			...
			String sUserName = Constants._prop.getProperty("mo.soap.TEKZIC.username");
			String sPassword = Constants._prop.getProperty("mo.soap.TEKZIC.password");
			...
			Util.logger.info(className + " fw mo.@info :\t@sUser:"
		 	...
		 	int iReturn = proxy.sendMo(sUserName, sPassword, sMsisdn,
		 			sServiceNumber, sServiceCode, sInfo, iRequestId+"", sOperator, iChannel_Type, iMulti) ;
		 	/*moReveive(sUserName, sPassword, sMsisdn, sServiceNumber, sServiceCode, sInfo, iRequestId, sOperator, iChannel_Type);*/
