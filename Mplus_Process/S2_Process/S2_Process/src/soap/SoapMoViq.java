...
public class SoapMoViq extends QuestionManager {
	String className = "SoapMoViq ";
	...
	protected Collection getMessages(Properties prop, MsgObject msgObject,
		...
		try {
			...
			String url = Constants._prop.getProperty("mo.soap.viq.url");
			String sUserName = Constants._prop
					.getProperty("mo.soap.viq.username");
			String sPassword = Constants._prop
					.getProperty("mo.soap.viq.password");
			...
			int iReturn = proxy.moReceiver(sUserName, sPassword, sMsisdn,
					sServiceNumber, sServiceCode, sInfo, iRequestId, sOperator,
					iChannel_Type);
			// moReveive(sUserName, sPassword, sMsisdn, sServiceNumber,
			...
			} else if (iReturn == 2 || iReturn == 3 || iReturn == 4
					|| iReturn == 5 || iReturn == 6 || iReturn == 255) {
