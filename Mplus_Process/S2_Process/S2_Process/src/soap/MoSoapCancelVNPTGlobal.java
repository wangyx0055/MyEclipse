...
public class MoSoapCancelVNPTGlobal extends QuestionManager {
	String className = "MoSoapCancelVNPTGlobal  ";
	...
	protected Collection getMessages(Properties prop, MsgObject msgObject,
		...
		try {
			...
			String sUserName = Constants._prop
					.getProperty("mo.soap.VNPTGlobal.username");
			String sPassword = Constants._prop
					.getProperty("mo.soap.VNPTGlobal.password");
