...
public class MoSoapCanceMobiTech extends QuestionManager {
	String className = "MoSoapCanceMobiTech  ";
	@Override
...
*/					DBUtil.UnRegisterServices(msgObject, keyword);
				//}
		 		...
		 		Util.logger.info(className +" return !=1 add 2 mo_queue_error @user:"+msgObject.getUserid());
