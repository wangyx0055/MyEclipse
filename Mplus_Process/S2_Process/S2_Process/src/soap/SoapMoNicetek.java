...
import org.tempuri.MMServiceSoapProxy;
...
public class SoapMoNicetek extends QuestionManager {
	String className = "SoapMoNicetek ";
	...
	protected Collection getMessages(Properties prop, MsgObject msgObject,
		...
		try {
			MMServiceSoapProxy proxy = new MMServiceSoapProxy();
			String url = Constants._prop.getProperty("mo.soap.nicetek.url");
			String sUserName = Constants._prop
					.getProperty("mo.soap.nicetek.username");
			String sPassword = Constants._prop
					.getProperty("mo.soap.nicetek.password");
