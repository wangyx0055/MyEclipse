...
public class Subgeneric extends QuestionManager {
	...
	private int insertData(String user_id, String service_id,
		...
		String sqlInsert = "Insert into "
				+ mlist
				+ "(user_id, service_id, date,command_code,request_id, message_type,mobile_operator,mt_free,duration, amount, content_id) values ('"
				+ user_id
				+ "','"
				+ service_id
				+ "','"
