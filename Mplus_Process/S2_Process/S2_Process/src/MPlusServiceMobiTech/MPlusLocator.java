...
public class MPlusLocator extends org.apache.axis.client.Service implements MPlusServiceMobiTech.MPlus {
    ...
    private java.lang.String MPlusPort_address = "http://203.128.246.197:8000/mplus-services/mplus";
    ...
    public MPlusServiceMobiTech.MPlusPort getMPlusPort() throws javax.xml.rpc.ServiceException {
    ...
    public MPlusServiceMobiTech.MPlusPort getMPlusPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            MPlusServiceMobiTech.MPlusPortStub _stub = new MPlusServiceMobiTech.MPlusPortStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (MPlusServiceMobiTech.MPlusPort.class.isAssignableFrom(serviceEndpointInterface)) {
                MPlusServiceMobiTech.MPlusPortStub _stub = new MPlusServiceMobiTech.MPlusPortStub(new java.net.URL(MPlusPort_address), this);
                _stub.setPortName(getMPlusPortWSDDServiceName());
                return _stub;
            }
        }
