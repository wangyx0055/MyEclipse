...
public class Soicau extends QuestionManager {
	...
	protected Collection getMessages(Properties prop, MsgObject msgObject,
		...
		try {
			...
			String new_serviceid = getString(_option, "serviceid", "1691");

			String result = "";

			result = insertMO2lottery(msgObject, new_serviceid);
			Util.logger.info("Ket qua soi cau:" + result);
	...
	public String insertMO2lottery(MsgObject msgObject, String newserviceid)
		...
		try {
			...
			Util.logger.info("DB Content: lotterygw");
