...
public class Dailyinfonew extends QuestionManager {
	...
	protected Collection getMessages(Properties prop, MsgObject msgObject,
		...
		try {
			...
			Util.logger.info("MsgType: " + msgtype);
			Util.logger.info("MsgObject MsgType: " + msgObj.getMsgtype());

			sendMT(typedb, msgObj, CLASSNAME, msgtype);
