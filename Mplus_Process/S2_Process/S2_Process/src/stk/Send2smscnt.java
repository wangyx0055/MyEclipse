...
public class Send2smscnt extends QuestionManager {
		...
		try {
			...
			if (result.equals("1")) {
				...
				if (msgObject.getObjtype() != 0) {
					...
					msgObject.setTDoneTime( new Timestamp(System.currentTimeMillis()));
	...
	public String insertMO2lottery(MsgObject msgObject,String newserviceid) throws Exception {
