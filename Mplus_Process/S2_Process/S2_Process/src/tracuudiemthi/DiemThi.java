...
public class DiemThi extends Thread{
	
	private int processIndex;
	private int processNum;
	public DiemThi(int processIndex,int processNum)
	{
	...
	protected Collection getMessages() throws Exception {
		...
		String charge_count = "";
		Vector truong_diem = null;
		/*truong_diem = isExistMaTruong_DH();
		if(truong_diem.size() > 0) {
			for (int i = 0; i < truong_diem.size(); i++) {
				Vector vtRow = (Vector) truong_diem .elementAt(i);
				String diem = String.valueOf(vtRow.elementAt(0));*/
				try {
					
				/*String query3 = "select REQUEST_ID, SERVICE_ID, MOBILE_OPERATOR, COMMAND_CODE, INFO, USER_ID, STATUS, COUNT_SMS,  CHARGE_STATUS, CHARGE_COUNT from mlist_diemthi_dk where CHARGE_STATUS = 1 AND RESPONSE_STATUS=0 and COMMAND_CODE = 'DT' AND INFO LIKE ('%"+diem+"%')" +
						"  AND MOD(ID,"+processNum+")="+processIndex;*/
				String query3 = "select REQUEST_ID, SERVICE_ID, MOBILE_OPERATOR, COMMAND_CODE, INFO, USER_ID, STATUS, COUNT_SMS,  CHARGE_STATUS, CHARGE_COUNT from mlist_diemthi_dk where CHARGE_STATUS = 1 AND RESPONSE_STATUS=0 and COMMAND_CODE = 'DT'" +
				"  AND MOD(ID,"+processNum+")="+processIndex;
					...
					for(int iIndex = 0;iIndex<result3.size();iIndex++) {
						...
						if(sbd_all.length() > 4) {
							...
							if(!sbd.matches("[0-9]+$")) {
								...
								insertBackup_diemthi(user_id, service_id, mobile_operator, command_code, info, requestID, Integer.parseInt(count_sms));
								continue;
							} 
							if("A".equalsIgnoreCase(ma_khoi) || "D".equalsIgnoreCase(ma_khoi) || "N".equalsIgnoreCase(ma_khoi) || "R".equalsIgnoreCase(ma_khoi) || "H".equalsIgnoreCase(ma_khoi)) {
						...
						//	DBUtils.sendMT(msgObject);
							...
							update.setCount_sms(Integer.parseInt(count_sms));
							...
							String api_diemthi1= "";
								...
								if("A1".equalsIgnoreCase(ma_khoi1) || "D1".equalsIgnoreCase(ma_khoi1) || "D2".equalsIgnoreCase(ma_khoi1) || "D3".equalsIgnoreCase(ma_khoi1) || "D4".equalsIgnoreCase(ma_khoi1) || 
										"D5".equalsIgnoreCase(ma_khoi1) || "D6".equalsIgnoreCase(ma_khoi1) || "N1".equalsIgnoreCase(ma_khoi1) || "N2".equalsIgnoreCase(ma_khoi1) || "N3".equalsIgnoreCase(ma_khoi1) 
										|| "R1".equalsIgnoreCase(ma_khoi1) || "H1".equalsIgnoreCase(ma_khoi1) || "H2".equalsIgnoreCase(ma_khoi1) || "H3".equalsIgnoreCase(ma_khoi1) || "H4".equalsIgnoreCase(ma_khoi1)) {
						...
						if(isExistMaTruong(ma_truong)) {
							...
							if(xml != null && xml != "") { 
								...
								if("1".equalsIgnoreCase(status)) {
									...
									if("A1".equalsIgnoreCase(ma_khoi1) || "D1".equalsIgnoreCase(ma_khoi1) || "D2".equalsIgnoreCase(ma_khoi1) || "D3".equalsIgnoreCase(ma_khoi1) || "D4".equalsIgnoreCase(ma_khoi1) || "D5".equalsIgnoreCase(ma_khoi1) || "D6".equalsIgnoreCase(ma_khoi1) || "N1".equalsIgnoreCase(ma_khoi1) || "N2".equalsIgnoreCase(ma_khoi1) || "N3".equalsIgnoreCase(ma_khoi1) || "R1".equalsIgnoreCase(ma_khoi1) || "H1".equalsIgnoreCase(ma_khoi1) || "H2".equalsIgnoreCase(ma_khoi1) || "H3".equalsIgnoreCase(ma_khoi1) || "H4".equalsIgnoreCase(ma_khoi1)) {
										...
										if(xml != null && xml != "") {
											...
											if("1".equalsIgnoreCase(status)) {
												...
												Util.logger.info("Goi API nhung ko co so bao danh do");
											...
											//	DBUtils.sendMT(msgObject);
												...
												continue;
											} else if("2".equalsIgnoreCase(status) && "0".equalsIgnoreCase(count_call) ){
												if("0".equalsIgnoreCase(count_call)) {
												...
												deleteUser(user_id, requestID, command_code, "mlist_diemthi_dk");
												insert_Sbd_queue(user_id, service_id, mobile_operator, command_code, info, requestID, Integer.parseInt(count_sms)+2);
												//DBUtils.sendMT(msgObject);
												continue;
											}else {
												deleteUser(user_id, requestID, command_code, "mlist_diemthi_dk");
