...
public class DiemThi_1 extends Thread{
...
public void run(){
	...
	protected Collection getMessages() throws Exception {
		...
		try {
			...
			String query3 = "select REQUEST_ID, SERVICE_ID, MOBILE_OPERATOR, COMMAND_CODE, INFO, USER_ID, STATUS, COUNT_SMS,  CHARGE_STATUS, CHARGE_COUNT from mlist_diemthi_dk where RESPONSE_STATUS=0 and COMMAND_CODE = 'DT' AND MOD(ID,5)=1";
