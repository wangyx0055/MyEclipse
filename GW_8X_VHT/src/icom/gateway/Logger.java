...
public class Logger {
	 ...
	 * Log verbose messages
	 */
	public static void verbose(String pre, String data) {
		if (logVerbose)
			log("VERBOSE", pre + data);
		if (DebugLogger.getEnabled())
			DebugLogger.log(pre + data);
	}
	
	public static void verbose(int pre, String data) {
		if (logVerbose)
			log("VERBOSE", pre + data);
		if (DebugLogger.getEnabled())
			DebugLogger.log(pre + data);
	...
	public static void error(String classname, String data) {
		...
		// DBTools.ALERT(classname, data, "major", data,
	...
	public static void crisis(String message) {
		if (logCrisis) {
			log("CRISIS", message);
			// DBTools.ALERT("gateway", message, "serious", message,
			// "gatewayadmin");
	...
	public static void crisis(String classname, String message) {
		...
		if (logCrisis) {
			log("CRISIS", message);
			// DBTools.ALERT(classname, message, "serious", message,
			// "gatewayadmin");
