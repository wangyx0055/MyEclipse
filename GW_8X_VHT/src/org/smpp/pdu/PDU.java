...
public abstract class PDU extends ByteData
{
    ...
    throws InvalidPDUException, PDUException
    {
        ...
        try {
            ...
            if (buffer.length()<Data.PDU_HEADER_SIZE) {
                    ...
                    Logger.verbose(DPDU,"PDU.setData() not enough data for header in the buffer " +
                                buffer.getHexDump());
            ...
            //if (debug.active(DPDU)) {
                Logger.verbose(DPDU,"PDU.setData() parsing header " +
            ...
            if (Logger.isverbose()) {
                if (getCommandLength()>Data.PDU_HEADER_SIZE) {
                    ...
                    Logger.verbose(DPDU,"PDU.setData() parsing body " +
    ...
    public void setApplicationSpecificInfo(Object key, Object value)
    {
        ...
        Logger.verbose(DPDU,"setting app spec info key=\""+
    ...
    public Object getApplicationSpecificInfo(Object key)
    {
        ...
        Logger.verbose(DPDU,"getting app spec info key=\""+
                    key+"\" value=\""+(value==null?"null":value)+"\"");
        return value;
    }
