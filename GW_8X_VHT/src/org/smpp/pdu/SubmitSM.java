 ...
 * 19-11-01 ticp@logica.com added support for multibyte string encoding for
 * short message
 */
...
public class SubmitSM extends Request {
	...
	private TLVByte sourceAddrSubunit = new TLVByte(
			Data.OPT_PAR_SRC_ADDR_SUBUNIT);
	...
	private TLVByte callbackNumPresInd = new TLVByte(
			Data.OPT_PAR_CALLBACK_NUM_PRES_IND);
	private TLVOctets callbackNumAtag = new TLVOctets(
			Data.OPT_PAR_CALLBACK_NUM_ATAG, Data.OPT_PAR_CALLBACK_NUM_ATAG_MIN,
			Data.OPT_PAR_CALLBACK_NUM_ATAG_MAX); // 1-65
	...
	private TLVByte msMsgWaitFacilities = new TLVByte(Data.OPT_PAR_MSG_WAIT); // bit
	// mask
	private TLVByte numberOfMessages = new TLVByte(Data.OPT_PAR_NUM_MSGS);
	private TLVEmpty alertOnMsgDelivery = new TLVEmpty(
			Data.OPT_PAR_ALERT_ON_MSG_DELIVERY);
	...
	private TLVShort sfoneChargeFlag = new TLVShort((short)5120);
