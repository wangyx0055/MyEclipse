...
public abstract class ContentAbstract
{
	...
	private static int sendMT(MsgObject msgObject)
	{
		...
		try
		{
			...
			boolean Result = mSendQueue.Insert(idseq, msgObject.getUserid(), msgObject.getServiceid(), msgObject.getMobileoperator(), msgObject.getKeyword(),
					msgObject.getUsertext(), null, null, "0", Integer.toString(msgObject.getMsgtype()), msgObject.getRequestid().toString(), "1",
