...
public class Ttamnhac extends ContentAbstract {
	...
	protected Collection getMessages(MsgObject msgObject, Keyword keyword)
		...
		try {
			...
			String database_customer = "icom_ttamnhac_customer";
			...
			Hashtable numberDelay = Threadttamnhac.lastestnumber.SECRET_NUMBER;
			...
			if (Threadttamnhac.lastestnumber.isProcess == 0) {
				...
				messages.add(new MsgObject(msgObject));
				return messages;
			} else if ((Threadttamnhac.lastestnumber.isProcess == 1)) {
				...
				if (sTokens.length < 2) {
					mtContent = "Tin nhan sai cu phap. Soan tin  "
							...
							+ "  <tenbaihat> gui "
							+ service_id
							+ " de tham gia chuong trinh Thu tai am nhac. DTHT: 1900571566.";
