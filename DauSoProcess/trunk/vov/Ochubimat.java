...
public class Ochubimat extends ContentAbstract {
	...
	protected Collection getMessages(MsgObject msgObject, Keyword keyword)
		...
		try {
			...
			String database_customer = "icom_ochubimat_customer";
			...
			Hashtable numberDelay = Threadochubimat.lastestnumber.SECRET_NUMBER;
			...
			if (Threadochubimat.lastestnumber.isProcess == 0) {
				...
				messages.add(new MsgObject(msgObject));
				return messages;
			} else if ((Threadochubimat.lastestnumber.isProcess == 1)) {
