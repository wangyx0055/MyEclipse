...
public class NhanDienHN extends ContentAbstract {
	...
	protected Collection getMessages(MsgObject msgObject, Keyword keyword)
		...
		try {
			...
			String database_customer = "icom_thantuonghn_customer";
			String database_vote = "icom_thantuonghn_vote";
			...
			//
			String mtContent = "";
			Hashtable numberDelay = Threadnhandienhn.lastestnumber.SECRET_NUMBER;
			...
			if (Threadnhandienhn.lastestnumber.isProcess == 0) {
				...
				messages.add(new MsgObject(msgObject));
				return messages;
			} else if ((Threadnhandienhn.lastestnumber.isProcess == 1)) {
			...
			} else if ((Threadnhandienhn.lastestnumber.isProcess == 2)) {
			...
			} else if ((Threadnhandienhn.lastestnumber.isProcess == 3)) {
