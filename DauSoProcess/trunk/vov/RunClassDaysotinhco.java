...
public class RunClassDaysotinhco extends Thread {
	...
	private Hashtable getTime() {
		...
		try {
			...
			String sqlSelect = "SELECT id, number, start_time, block1, block2, block3, block4, block5, block6, end_time, isprocess, current FROM icom_dayso_config WHERE active = 1";
