...
public class RunClassNhandienhn extends Thread {
	...
	private Hashtable getTime() {
		...
		try {
			...
			String sqlSelect = "SELECT id, tenthantuong, start_time, block1, block2, block3, end_time, isprocess, answer FROM icom_thantuonghn_config WHERE active = 1";
			...
			if (statement.execute()) {
				...
				while (rs.next()) {
					...
					secretNumber.put("answer", result[8]);
				}
