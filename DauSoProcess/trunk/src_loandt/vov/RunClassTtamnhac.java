...
public class RunClassTtamnhac extends Thread {
	...
	private Hashtable getTime() {
		...
		try {
			...
			String sqlSelect = "SELECT id,current,start_time, block1, block2, block3, block4, block5, isprocess FROM icom_ttamnhac_config WHERE active = 1";
