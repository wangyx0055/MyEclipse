...
public class Chiectui extends ContentAbstract {
	...
	protected Collection getMessages(MsgObject msgObject, Keyword keyword)
		...
		try {
			...
			String database_customer = "icom_chiectui_customer";
			...
			Hashtable numberDelay = Threadchiectui.lastestnumber.SECRET_NUMBER;
			...
			if (Threadchiectui.lastestnumber.isProcess == 0) {
				...
				messages.add(new MsgObject(msgObject));
				return messages;
			} else if ((Threadchiectui.lastestnumber.isProcess == 1)) {
