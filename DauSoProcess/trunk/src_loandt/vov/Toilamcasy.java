...
public class Toilamcasy extends ContentAbstract {

	private static final String DBCONTENT = "toilamcasy_config";
	private static final String DBCUSTOMER = "toilamcasy_customer";
			...
			if (sTokens.length < 2) {
				...
				if (_type == 1) {
					...
					if (sTokens.length < 3) {
						...
						if (!checkCode(sCodes, code)) {
							msgObject
									.setUsertext("Ma so giong hat cua ngay hom nay:"
											+ sCode
											+ ".Soan tin "
					+ sKeyword
					+ " "
