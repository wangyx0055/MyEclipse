		...
		try {
			...
			nick = nick.replace(" ","");
						...
						{							
							if(checkUserID == false) // so dien thoai nay chua co nick
							{
								...
								{														
									...
									msgObject.setUsertext("De gui den cong dong Radio Chat loi nhan va lam quen voi cac thanh vien khac soan : TR <noidungloinhan> gui 8551.");
									msgObject.setMsgtype(1);
									msgObject.setContenttype(21);
									DBUtil.sendMT(msgObject);
							...
							{
								msgObject.setUsertext("Ban da co nick tren he thong. DTHT: 1900571566");
								msgObject.setMsgtype(1);
								msgObject.setContenttype(21);
								DBUtil.sendMT(msgObject);
							...
							msgObject.setUsertext("Tin nhan khong hop le. De tham gia Radio Chat, B1: soan: RC <nick> gui 8751. B2: soan: RC <gioitinh> <sothich> gui 8151. DTHT:1900571566");
							msgObject.setMsgtype(1);
							msgObject.setContenttype(21);
							DBUtil.sendMT(msgObject);
				...
				{								
					...
					{						
						if(serviceID.equalsIgnoreCase("8751"))
							...
							try{
								...
								{
									msgObject.setUsertext("Ban chua dang ky nick chat tren he thong Radio Chat. Soan: RC <nick> gui 8751 de dang ki nick, tham gia Chat cung ban be. DTHT: 1900571566.");
									msgObject.setMsgtype(1);
									msgObject.setContenttype(21);
									DBUtil.sendMT(msgObject);
								...
								else
								{
									...
									int sess = dbSelect.getSession(msgObject.getTTimes().toString());
							...
							{
								msgObject.setUsertext("De gui den cong dong Radio Chat loi nhan va lam quen voi cac thanh vien khac soan : TR <noidungloinhan> gui 8751.");
								msgObject.setMsgtype(1);
								msgObject.setContenttype(21);
								DBUtil.sendMT(msgObject);
					...
					if(commandCode.equalsIgnoreCase("CB"))
					{						
						if(serviceID.equalsIgnoreCase("8751"))
							{
							try{
								...
								{
									msgObject.setUsertext("Ban chua dang ky nick chat tren he thong Radio Chat. Soan: RC <nick>  gui 8751 de dang ky nick, tham gia Chat cung ban be. DTHT: 1900571566.");
									msgObject.setMsgtype(1);
									msgObject.setContenttype(21);
									DBUtil.sendMT(msgObject);
								...
								Util.logger.error ("Info:" + msgObject.getUsertext());
								msgObject.setUsertext("Yc ko hop le. De chon nguoi choi, soan: CB <sothutu> gui 8751. Hay thao tac nhanh de tro thanh nguoi choi truc tiep cung Radio Chat. DTHT:1900571566.");
								msgObject.setMsgtype(1);
								msgObject.setContenttype(21);
								DBUtil.sendMT(msgObject);		
					...
					{	
						if(serviceID.equalsIgnoreCase("8751"))
						{
							try{
								...
								String content = "Ban nhan duoc tin nhan tu " + nickGet + " tren Radio Chat: " + contentGet +" ";
					...
					{	
						if(serviceID.equalsIgnoreCase("8551"))
						{
							try{
					...
					{	
						if(serviceID.equalsIgnoreCase("8751"))
						{
							try{
								...
								String temp  = info.substring(songname.length() +1);
								String phone = temp.substring(0, temp.indexOf(" "));
								String content = temp.substring(phone.length() +1);	
					...
					{	
						if(serviceID.equalsIgnoreCase("8751"))
						{
							try{
								...
								int session = dbSelect.getSession(msgObject.getTTimes().toString());
								...
								String strQuestion1_start = time_question.substring(0,time_question.indexOf(";"));
								String temp = time_question.substring(strQuestion1_start.length() +1);
								String strQuestion2_start = temp.substring(0,temp.indexOf(";"));
								String strQuestion2_end = temp.substring(strQuestion2_start.length() +1);
								Timestamp question1_start = Timestamp.valueOf(strQuestion1_start);
								Timestamp question2_start = Timestamp.valueOf(strQuestion2_start);
								Timestamp question2_end = Timestamp.valueOf(strQuestion2_end);
								
								Util.logger.error ("question1_start:" + question1_start.getTime());
								Util.logger.error ("question2_start:" + question2_start.getTime());
								Util.logger.error ("question2_end:" + question2_end.getTime());
								Util.logger.error ("time:" + time.getTime());
								
								Util.logger.error ("userID:" + userID);
								...
								if (userID.equalsIgnoreCase(player_boy))									
								{
									...
									else if(time.getTime() >= question2_start.getTime() && time.getTime() <= question2_end.getTime())
									{										
