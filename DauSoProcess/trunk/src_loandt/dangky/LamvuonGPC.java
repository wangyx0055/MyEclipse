...
public class LamvuonGPC extends ContentAbstract {
	...
	protected Collection getMessages(MsgObject msgObject, Keyword keyword)
		...
		String MLIST = "mlist_farmgpc";
		String MLISTCANCEL = "mlist_farmgpc_cancel";
		...
		try {
			...
			int day15 = cal15.get(Calendar.DATE);
			int month15 = cal15.get(Calendar.MONTH) + 1;

			// Sau 14 ngay
			Calendar cal14 = Calendar.getInstance();
			cal14.add(Calendar.DATE, 14);
			int day14 = cal14.get(Calendar.DATE);
			int month14 = cal14.get(Calendar.MONTH) + 1;
			if ("VINAPHONE".equalsIgnoreCase(msgObject.getMobileoperator())
					|| "GPC".equalsIgnoreCase(msgObject.getMobileoperator())) {
				infoid = "vinaphone";
			} else {
				infoid = "other";
			}
			...
			if ("other".equalsIgnoreCase(infoid)) {
				msgObject
						.setUsertext("Ban nhan tin sai cu phap.Dien thoai ho tro 1900571566");
			...
			if (sTokens.length == 1) {
				...
				if (isexist(msgObject.getUserid(), MLIST)) {
					...
					msgObject
							.setUsertext("Ban da dang ky va dang choi game Lam Vuon That Tuyet.Soan tin "
									+ msgObject.getKeyword()
									+ " HD gui "
									+ msgObject.getServiceid()
									+ " de duoc ho tro ve cu phap.Chi tiet tai http://funzone.vn.DTHT 1900571566");
					...
					if (!isexist(msgObject.getUserid(), MLISTCANCEL)) {// Chua
						...
						// mt2
						msgObject
								.setUsertext("Cam on da su dung dich vu cua Vinaphone.Dien thoai ho tro 1900571566.");
						...
						msgObject
								.setUsertext("Chuc mung ban da dang ky thanh cong choi game Lam Vuon That Tuyet.Phi thue bao 10.000d/thang.De huy dich vu soan LV OFF gui 8151.Chi tiet tai http://funzone.vn");
						msgObject.setMsgtype(1);
						msgObject.setContenttype(0);
						DBUtil.sendMT(msgObject);
						Thread.sleep(1000);
						msgObject
								.setUsertext("Cam on ban da su dung dich vu cua Vinaphone.DTHT:1900571566");
						msgObject.setMsgtype(0);
						msgObject.setContenttype(0);
						DBUtil.sendMT(msgObject);
						Thread.sleep(1000);
				...
				if (sTokens[1].equalsIgnoreCase("OFF")) {// FA OFF Huy dich vu
					if (!isexist(msgObject.getUserid(), MLIST)) {
						...
						msgObject
								.setUsertext("Ban chua dang ky dich vu.Soan tin "
										+ msgObject.getKeyword()
										+ " gui "
										+ msgObject.getServiceid()
										+ " de dang ky tham gia game Lam Vuon That Tuyet.Dien thoai ho tro 1900571566.Chi tiet tai http://funzone.vn");
						msgObject.setMsgtype(1);
						msgObject.setContenttype(0);
						DBUtil.sendMT(msgObject);
						Thread.sleep(1000);
						...
						msgObject
								.setUsertext("Ban da huy thanh cong dich vu game Lam Vuon That Tuyet.De dang ky lai soan "
										+ msgObject.getKeyword()
										+ " gui "
										+ msgObject.getServiceid()
										+ ".Chi tiet tai http://funzone.vn");
						msgObject.setMsgtype(1);
						msgObject.setContenttype(0);
						DBUtil.sendMT(msgObject);
						Thread.sleep(1000);
						// mt2
						msgObject
								.setUsertext("Cam on ban da su dung dich vu cua Vinaphone.Dien thoai ho tro 1900571566");
						msgObject.setMsgtype(0);
						msgObject.setContenttype(0);
						DBUtil.sendMT(msgObject);
						Thread.sleep(1000);
					...
					msgObject
							.setUsertext("De dang ky game Lam vuon that tuyet.Soan "
									+ msgObject.getKeyword()
									+ " gui "
									+ msgObject.getServiceid()
									+ ".De HUY dich vu,soan "
