...
public class Daugiav6khoanggia extends ContentAbstract {
	protected Collection getMessages(MsgObject msgObject, Keyword keyword)
		...
		try {
			...
			String info = "Gia dang chiem uu the nam trong khoang $T1 den $T2. De biet muc gia ban muon da co nguoi dat chua, soan: VG  gui 8551";
