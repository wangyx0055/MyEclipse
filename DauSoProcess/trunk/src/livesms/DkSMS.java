...
public class DkSMS extends ContentAbstract {
	...
	protected Collection getMessages(MsgObject msgObject, Keyword keyword)
		...
		try {
			...
			if (!isexist(msgObject.getUserid(), "mlist_livesms")) {
				/* neu chua dang ky thi dang ky cho user */

				insertData(msgObject.getUserid(), msgObject.getServiceid(),
						msgObject.getKeyword(), "mlist_livesms", msgObject,
						nowday, 0);
				...
				msgObject
						.setUsertext("Ban da dang ky thanh cong dich vu SMS Color .Phi dv:5000d/thang.Bam vao link de download va cai dat trong dien thoai cua ban. DTHT:1900571566");
				msgObject.setMsgtype(1);
				msgObject.setContenttype(0);
				DBUtil.sendMT(msgObject);
				Thread.sleep(1000);
				msgObject
						.setUsertext("Live SMS:http://smslive.mobinet.vn/couffable/php/downloadtophone.php");
