...
public class inforUser extends ContentAbstract{
	...
	protected Collection getMessages(MsgObject msgObject, Keyword keyword)
		...
		try {
			...
			if (sTokens.length == 1) {
				msgObject
						.setUsertext("Tin ban gui khong hop le. De tim ban theo nam sinh, soan: VE namsinh gui 8551. De tim ban ban theo noi o va nam sinh, soan VE namsinh tinh gui 8551.");
