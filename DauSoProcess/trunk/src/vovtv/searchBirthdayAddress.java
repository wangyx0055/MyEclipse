...
public class searchBirthdayAddress extends ContentAbstract{
	...
	protected Collection getMessages(MsgObject msgObject, Keyword keyword)
		...
		try {
			...
			if (sTokens.length < 3) {
				msgObject
						.setUsertext("Tin ban gui khong hop le. De tim ban theo noi o va nam sinh, soan T namsinh tinh gui 8251.");
				...
				List<String> nick = findBirth(sTokens[1], sTokens[2]);
				String nick_example = "";
				if(nick.size() >0) {
					String allNick = "";
					...
					msgObject
					.setUsertext("Thanh vien sinh nam "+sTokens[1]+", o tinh "+sTokens[2]+": "+ allNick);
					msgObject.setMsgtype(1);
					msgObject.setContenttype(0);
					DBUtil.sendMT(msgObject);
					Thread.sleep(1000);
