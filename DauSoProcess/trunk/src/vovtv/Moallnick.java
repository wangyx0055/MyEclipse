...
public class Moallnick extends ContentAbstract {
	...
	protected Collection getMessages(MsgObject msgObject, Keyword keyword)
		...
		try {
			...
			msgObject
					.setUsertext("Ban da mo khoa de nhan tin chat rieng tu moi thanh vien khac. De gui noi dung chat: CR masonguoinhan noidungchat gui 8551. DTHT: 1900571566.");
			msgObject.setMsgtype(1);
			DBUtil.sendMT(msgObject);
			Thread.sleep(1000);
			return null;
	...
	private static boolean updateBlacklist(String userid) {
		...
		try {
			...
			String sqlUpdate = "UPDATE vovtv_nick_chan SET blacklist = 'x' WHERE upper(user_id)='"
