	...
	protected Collection getMessages(MsgObject msgObject, Keyword keyword)
		...
		try {
			...
			if (sTokens.length == 1) {
				...
				if (sTokens[1].length() > 160) {
					msgObject
							.setUsertext("Thong tin ban gui khong hop le. Vui long soan noi dung khac hoac goi 1900571566 de duoc huong dan chi tiet.");
					msgObject.setMsgtype(1);
					msgObject.setContenttype(0);
					DBUtil.sendMT(msgObject);
					Thread.sleep(1000);
					...
					if (infor == null) {
						msgObject
								.setUsertext("Ban chua dang ky Chat tren 360 do am nhac. Soan NAM/NU <nick> <noio> gui 6745. Nick viet lien khong dau, toi da 20 ky tu de Dang ky nick va tham gia chat cung ban be. DTHT:1900571566");
						msgObject.setMsgtype(1);
						msgObject.setContenttype(0);
						DBUtil.sendMT(msgObject);
						Thread.sleep(1000);
							...
							msgObject
							.setUsertext("Thong tin ban gui da chuyen sang che do cho duyet. Vui long don xem tren 360 do Am nhac. Binh chon bai hat soan: BC tenbaihat (viet lien khong dau) gui 6754.");
							msgObject.setMsgtype(1);
							msgObject.setContenttype(0);
							DBUtil.sendMT(msgObject);
							Thread.sleep(1000);
							// update vao bang NickName
							savechatqueue(msgObject.getUserid(), sTokens[1], chuoi, infor.get(1), infor.get(2), infor.get(3));
							
					}
				}

				msgObject.setUsertext("De chat rieng voi nick khac tren 360 do Am nhac, soan: C nicknguoiay noidungchat gui 6354. DTHT: 1900571566");
				msgObject.setMsgtype(0);
				msgObject.setContenttype(0);
				DBUtil.sendMT(msgObject);
				Thread.sleep(1000);
