		...
		try {
			...
			try {
				...
				if("8751".equalsIgnoreCase(msgObject.getServiceid())) {
					sodiem = "15";
				} else if("8651".equalsIgnoreCase(msgObject.getServiceid())) {
					sodiem = "6";
				} else if("8551".equalsIgnoreCase(msgObject.getServiceid())) {
					sodiem = "5";
				} else if("8451".equalsIgnoreCase(msgObject.getServiceid())) {
					sodiem = "4";
				} else if("8351".equalsIgnoreCase(msgObject.getServiceid())) {
					sodiem = "3";
				} else if("8251".equalsIgnoreCase(msgObject.getServiceid())) {
					sodiem = "2";
				}  else if("8151".equalsIgnoreCase(msgObject.getServiceid())) {
					sodiem = "1";
				}
			} catch (Exception e) {
			...
			if (sTokens.length == 1) {
				...
				if ("1".equalsIgnoreCase(result)) {
					listgame = "Ban da binh chon "
							...
							+ " diem cho bai hat "
							+ ten_bh
							+ ".Cam on da tham gia chuong trinh. Lien he 1900571566 de duoc ho tro.";
					...
					msgObject.setUsertext("Cac bai hat Hot: "+baihat);
					msgObject.setMsgtype(0);
					msgObject.setContenttype(0);
					DBUtil.sendMT(msgObject);
					Thread.sleep(1000);
					...
					msgObject.setUsertext("Cai dat bai hat " + ten_bh
							+ " lam nhac cho soan NHA " + ten_bh.replace(" ", "")
					...
					listgame = "Bai hat ban thich hien chua co tren he thong. Tra cuu ma bai hat soan MS tenbaihat Gui 8351. Vui long lien he 1900571566 de duoc ho tro.";
					msgObject.setUsertext(listgame);
					msgObject.setMsgtype(1);
					msgObject.setContenttype(0);
					DBUtil.sendMT(msgObject);
					...
					msgObject.setUsertext("Cac bai hat Hot:"
							+ baihat
							+ ".");
					msgObject.setMsgtype(0);
					msgObject.setContenttype(0);
