...
public class Huongdanbachmai extends ContentAbstract {
	...
	int[] result = new int[2];
			...
			String mt = "De dat lich kham, ban phai nhan tin dat lich kham truoc 24h so voi gio kham theo yeu cau.Soan: DLK HoTen Gio Ngay/thang Trieuchung gui 8551.HT: 1900571566";
			mt = getString(_option, "mt", mt);
			
			if ((!sTokens[1].equalsIgnoreCase("DLK"))||(sTokens.length<2))
			{
				mt="Tin nhan khong hop le. Soan: HD DLK gui 8151 de duoc huong dan. Ho tro:1900571566";
			}
