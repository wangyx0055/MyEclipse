...
public class sendXMLStoreZF {
	...
	private static String[] httpPost(String url, String xml) throws Exception {
		...
		Credentials credentials = new UsernamePasswordCredentials("ZoneFreeUser",
				"sgr45$#SF@#32");
	...
	public static String SendXML(int MediaType, String MSISDN, String MediaID,
		...
		String template = "<soap:Envelope xmlns:soap=\"http://www.w3.org/2003/05/soap-envelope\" xmlns:tem=\"http://tempuri.org/\">"
				...
				+ "   <soap:Body>"
				+ "    <tem:GetLinkMedia>"
				+ "  <tem:UserName>ZoneFreeUser</tem:UserName>"
				+ "  <tem:Password>sgr45$#SF@#32</tem:Password>"
				+ "   <tem:MSISDN>"
				+ MSISDN
				+ "</tem:MSISDN>"
				+ " <tem:MediaType>"
		...
		String url = "http://203.162.71.168:6888/GetMedia.asmx";
