...
public class sendXMLGAME {
	...
	public static String SendXML(String url, String MSISDN, int MediaType,
			String MediaID, int ChannelType, double Price, String RequestTime)
			throws Exception {
		String template =
		...
		"<soap:Envelope xmlns:soap=\"http://www.w3.org/2003/05/soap-envelope\" xmlns:tem=\"http://tempuri.org/\">"
				...
				+ "   <soap:Body>"
				+ "    <tem:GetLinkMedia>"
				+ "  <tem:UserName>ICom_HT</tem:UserName>"
				+ "  <tem:Password>1q2w3e4r5t</tem:Password>"
				+ "   <tem:MSISDN>"
				+ MSISDN
				+ "</tem:MSISDN>"
				+ "  <tem:MediaType>"
