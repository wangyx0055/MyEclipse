...
public class sendXMLRING8x51 {
	...
	private static String[] httpPost(String url, String xml) throws Exception {
		...
		Credentials credentials = new UsernamePasswordCredentials("ICom_HT",
				"1q2w3e4r5t");
	...
	public static String SendXML(String url, String Command, String MSISDN,
		...
		"<soap:Envelope xmlns:soap=\"http://www.w3.org/2003/05/soap-envelope\" xmlns:tem=\"http://tempuri.org/\">"
				...
				+ "   <soap:Body>"
				+ "    <tem:SetRingback>"
				+ "  <tem:Partner_UserName>ICom_HT</tem:Partner_UserName>"
				+ "  <tem:Partner_Password>1q2w3e4r5t</tem:Partner_Password>"
				+ " <tem:Command>" + Command + "</tem:Command>"
				+ "   <tem:MSISDN>" + MSISDN + "</tem:MSISDN>"
				+ "  <tem:ValidCode>" + ValidCode + "</tem:ValidCode>"
				+ "  <tem:RingBackCode>" +RingBackCode + "</tem:RingBackCode>"
