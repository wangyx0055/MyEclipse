...
public class SendKZVina extends ContentAbstract {

	protected Collection getMessages(MsgObject msgObject, Keyword keyword)
			throws Exception {

		String result = callWS(msgObject.getKeyword(), msgObject
	...
	public String callWS(String commandCode, String gatewayId,
			String messageId, String phoneNumber, String serviceNumber,
			String message) {

		String result = "";

		try {
			KaletStub.MOReceiver reStub = new KaletStub.MOReceiver();
			...
			KaletStub receiverServiceStub = new KaletStub();
			...
			KaletStub.MOReceiverResponse receiverStandardResponse = receiverServiceStub
					.MOReceiver(reStub);
