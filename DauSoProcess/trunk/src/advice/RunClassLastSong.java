...
public class RunClassLastSong extends Thread {
	...
	private Hashtable getTime() {
		...
		try {
			...
			String sqlSelect = "SELECT lastsong, subquestion, answer, start_time, block1, block2, block3, block4, block5, block6, block7, block8, finish_time, start_vote, end_vote, isprocess, id, block9 FROM icom_lastsong_config WHERE active = 1";
