 ...
 * @version 1.0
 */
public class Nhacchochude6x54New extends ContentAbstract {

	/* First String trÆ°á»›c cÃ¡c báº£n tin gá»­i */
	private static String viettelHot = "De tai cai dat nhac cho.Buoc1,soan: DK gui 1221.Buoc2,soan: BH maso gui 1221.CSKH:19001745.Danh sach ma bai hat nhac cho Hot nhat cua nhom: ";
	private static String vinaphoneHot = "De tai cai dat nhac cho.Buoc1,soan: DK gui 9194.Buoc2,soan: TUNE maso gui 9194.CSKH:19001745.Danh sach ma bai hat nhac cho Hot nhat cua nhom: ";
	private static String mobifoneHot = "De tai cai dat nhac cho.Buoc1,soan DK gui 9224.Buoc2,soan: CHON maso gui 9224.CSKH:19001745.Danh sach ma bai hat nhac cho Hot nhat cua nhom: ";
	private static String beelineHot = "De tai cai dat nhac cho.Soan: CHON masobaihat gui 1221.CSKH:19001745.Danh sach ma bai hat nhac cho Hot nhat cua nhom: ";
	...
	protected Collection getMessages(MsgObject msgObject, Keyword keyword)
		...
		String inv_msg = "Ban da nhan tin sai cu phap.De cai dat GPRS tu dong, soan GPRS gui 8751. De tai cac bai hat HOT nhat soan BH TOP gui 8751. CSKH: 19001745";
		String last_msg = "NC tenbaihat gui 8551";
		String ismtadd = "1";
		try {
			...
			/* Kiá»ƒm tra xem thuÃª bao cá»§a khÃ¡ch hÃ ng */
			...
			// Láº¥y sá»‘ thuÃª bao ngÆ°á»�i gá»­i
			String userid = msgObject.getUserid();
			/* Láº¥y ná»™i dung cá»§a ngÆ°á»�i gá»­i Ä‘áº¿n */
			...
			if (sTokens.length > 1) {
				...
				if ("".equalsIgnoreCase(resultMusic[0])) {
					...
					// Check xem ten casy cÃ³ khÃ´ng ? Náº¿u cÃ³ mÃ  lastid <>
					// "" thÃ¬
					// gá»­i mÃ£ nháº¡c HOT
	...
	/*
	 * Ghi láº¡i danh sÃ¡ch cÃ¡c khÃ¡ch hÃ ng há»‡ thá»‘ng khÃ´ng Ä‘Ã¡p á»©ng
	 * Ä‘Æ°á»£c yÃªu cáº§u
	 */
