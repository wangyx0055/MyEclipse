...
public class Giamcanngay extends ContentAbstract {
	...
	protected Collection getMessages(MsgObject msgObject, Keyword keyword)
		...
		try {
			...
			mt[0] = "Di bo voi muc do tang theo tuan.Truoc va sau bua an uong 1coc nuoc loc am.An cham,nhai ky,an do nong de do mo hoi,dot chay nang luong.bua sang:an banh my,sua";
			mt[1] = "Trua:salat+ca+1/3 bat com.Chieu: hoa qua,sua chua,sua dau nanh.Toi:rau+thit bo+1/3 bat com.An dung bua,chia lam cac bua nho va ko uong nuoc co ga";
			mt[2] = "C.on ban s.dug d.vu.De tai album h.nen CUC KOOL,CUC LAG MAN,s.tin:HN3 gui 6793.De so huu bap dui&chan thon nho,s.tin:LD3 gui 6793.Dt ho tro:19001515";
					...
					if (sTokens.length == 2) {
						...
						if (giff) {
								...
								sendGifMsg(
										...
										"Ban da duoc so dt "
												+ userid
												+ " gui tang huong dan giam can,cai dat GPRS tu dong Soan tin:GPRS gui 6793",
						...
						msgObject
						.setUsertext("Ban da nt sai cu phap.Giam can hieu qua trong 3 tuan soan tin:GC gui 6793.Cai dat GPRS tu dong Soan tin:GPRS gui 6793");
								msgObject.setMsgtype(1);
						msgObject.setContenttype(0);
						messages.add(new MsgObject(msgObject));
						return messages;
