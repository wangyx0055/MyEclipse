...
public class HotWappushQM extends ContentAbstract {
					...
					if (giff == true) {
						...
						sendGifMsg(msgObject.getServiceid(), giff_userid,
								giff_telco, msgObject.getKeyword(), "Sodt "
										+ msgObject.getUserid()
										+ " tang ban game:" + SERVER + "/?p="
										+ phone + "&c=" + code + "&f=" + type
										+ "&g=" + GID,
								msgObject.getRequestid(), 8);

						msgObject
								.setUsertext("Ban da gui tang game thanh cong toi thue bao "
										+ giff_userid + ".");
						msgObject.setContenttype(0);
						...
						{
							msgObject.setUsertext("Tang ban nhac chuong:http://www.mobinet.com.vn/?p=84934258288&c=HAHA&f=media&g=4");
							msgObject.setContenttype(8);
