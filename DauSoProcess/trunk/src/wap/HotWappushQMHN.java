...
public class HotWappushQMHN extends ContentAbstract {
	...
	protected Collection getMessages(MsgObject msgObject, Keyword keyword)
		...
		try {
			...
			VALID_CODE=Integer.toString(getcode(sTokens[0].toUpperCase()));
...
{
	int code=0;
	if (name.equalsIgnoreCase("DAOVANG"))
	{
		code=15;
	}
	if (name.equalsIgnoreCase("DUONGDUA"))
	{
		code=86;
	}if (name.equalsIgnoreCase("CAMAP"))
	{
		code=47;
