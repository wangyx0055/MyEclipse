...
public class InfosByDate_new extends ContentAbstract {
	...
	private String mtReturn(String userid, String serviceid, String keyword,
		...
		return getInfo(SDATE, INFO_ID,DBCONTENT);
	}

	private String getInfo(String sDate, String infoid,String dbcontent) {
