 ...
 * @version 1.0
 */
public class Nhaccho_noel extends ContentAbstract {
	...
	protected Collection getMessages(MsgObject msgObject, Keyword keyword)
		...
		try {
			...
			if (sTokens.length > 1) {
				...
				Util.logger.info("aaaaaaaaa: " + lastid);
				String info2Client = "";
	...
	private static boolean saveClient(String userid, String operator,
		...
		try {
			...
			String sqlInsert = "INSERT INTO songxanh_list_customer( userid, operator, keyword, serviceid, timesend, requestid) VALUES ('"
					+ userid
					+ "','"
			...
			if (statement.execute()) {
				Util.logger.error("Insert into songxanh_list_customer");
				return false;
			}
			return true;
