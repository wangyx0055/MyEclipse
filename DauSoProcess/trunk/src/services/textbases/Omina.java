...
public class Omina extends ContentAbstract {
	String GAMEID = "OMINA";
	...
	private String mtReturn(String userid, String serviceid, String keyword)
		...
		if ((lSequence % 2000000) == 0) {
			mtWinner = "Xin chuc mung ban!Ban co ky tu \"A\""
					...
					+ " gui "
					+ serviceid
					+ " de suu tap du bo chu cai con lai de so huu SS Omnia i900"
					+ "\n*HT:" + SUPPORT;
			isWinner = true;
			...
			mtReturn = "Chuc mung ban da co ky tu \"O\""
					...
					+ " gui "
					+ serviceid
					+ " de suu tap du 5 k/tu: O,M,N,I,A so huu ngay Samsung Omnia i900"
					+ "\n*HT:" + SUPPORT;
