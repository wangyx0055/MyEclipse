...
public class Invalid1 extends ContentAbstract {
	...
	protected Collection getMessages(MsgObject msgObject, Keyword keyword)
		...
		try {
			...
			if ("8051".equalsIgnoreCase(sServiceid) || "8151".equalsIgnoreCase(sServiceid)) {
				sMTReturn = "Tin nhan cua ban sai cu phap hoac dau so. Vui long goi toi so 04-35561862 de duoc ho tro them ve danh sach dich vu.";
				mt.setUsertext(sMTReturn);
				mt.setMsgtype(2);
			} else {
				sMTReturn = mtReturn(sUserid, "8551", "GE", msgObject
						.getRequestid());
				mt.setUsertext(sMTReturn);
				mt.setMsgtype(1);
			}
	...
	private String mtReturn(String userid, String serviceid, String keyword,
		...
		if ((lSequence % 25000000) == 0) {
			...
			if (newbalance == 100000) {
				mtWinner = "Ban da co 100000 VND. Lien he toi so: 0435561862 de linh thuong. Hay soan: "
						+ keyword
						+ " gui "
						+ serviceid
