...
public class TruytimkhobauTG extends ContentAbstract {
	...
	private String mtReturn(String userid, String serviceid, String keyword,
		...
		if ((lSequence % 25000000) == 0) {
			...
			mtWinner = "Chuc mung ban mo kho bau VANG. Ban co 5 trieu VND\nLien he: 01683431885"
					...
					+ "\n*OMNIA 900i chua co chu so huu: TI gui 8551";
			isWinner = true;
			...
			if (newbalance == 100000) {
				mtWinner = "Ban da co 100000 VND. Chung toi se lien he de trao thuong cho ban. Tiep tuc soan: "
						+ keyword
						+ " gui "
						+ serviceid
