...
public class Lichvansu extends ContentAbstract {
	...
	protected Collection getMessages(MsgObject msgObject, Keyword keyword)
		...
		try {
			...
			ALLCONTENTS = getAllcontentLCS(GAME_ID, NUM_DAY);
	...
	public String[] getAllcontentLCS(String gameid, int numday) {
		String[] cnttemp = new String[numday + 1];
		String sqlSELECT = "SELECT content FROM icom_infoservice WHERE upper(info_type) = '"
				+ gameid.toUpperCase() + "'";
