...
public class PlayDautruong extends Thread {
	
	private String user_id = "84906113317";
	private String operator = "VMS";
	private String session_id = "9";
	private String end_date = "2009-07-05 23:57:00";
	...
	private void checkandplay() {
		...
		try {
			...
			stmt = connection.prepareStatement(
					"SELECT user_id FROM icom_dautruong_user  where session_id="
		...
		while (ConsoleSRV.processData) {
			...
			try {
				...
				if (currtime < endtime) {
					...
					Util.logger.info("Playdautruong:" + endtime + "@" + currtime);
				}

				Random iRandom = new Random();
				int i = iRandom.nextInt(30 * 1);
				i = i + 10;
				sleep(1000 * i * 1);
