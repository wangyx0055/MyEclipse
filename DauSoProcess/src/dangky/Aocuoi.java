...
public class Aocuoi extends ContentAbstract {
	...
	int[] result = new int[2];
			...
			saveClient(msgObject.getUserid(),stt);
			String mt = "Ban chua nhan duoc giai thuong cua Anh vien Cam Nang Cuoi. Moi ban tiep tuc nhan tin CNC gui 6354 de co the nhan duoc giai thuong 20trieu.";
			if (stt==10)
			{
				mt="Chuc mung ban da nhan duoc giai thuong phu la Coupon giam gia 500.000VND/ 01 goi dich vu khi thuc hien tai Anh vien Cam Nang Cuoi 83 Thai Ha, HN.";
			}
			else
			if (stt==10000)
			{
				mt="Chuc mung ban da nhan duoc giai thuong phu la Coupon giam gia 5.000.000VND/ 01 goi dich vu khi thuc hien tai Anh vien Cam Nang Cuoi 83 Thai Ha, HN.";
	...
	private static int findCode() {
		...
		try {
			...
			String sqlSelect = "SELECT stt FROM user_aocuoi order by stt desc limit 1";
	...
	private static boolean saveClient( String userid, int stt) {
		...
		try {
			...
			String sqlInsert = "INSERT INTO user_aocuoi (user_id,stt)" + "VALUES(?,?)";
