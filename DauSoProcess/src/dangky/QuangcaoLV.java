...
public class QuangcaoLV extends ContentAbstract {
	...
	int[] result = new int[2];
			...
			String mt = "Chao mung ban da den voi game Lam vuon that tuyet. Moi ban vao day http://funzone.vn/lamvuon de choi game.Chi tiet tai:http://funzone.vn ###Chuc ban co nhung phut giay vui ve va tro thanh mot nguoi lam vuon gioi.Cung nhau chia se kinh nghiem va ket ban trong trang trai hanh phuc.DTHT:1900561566";
