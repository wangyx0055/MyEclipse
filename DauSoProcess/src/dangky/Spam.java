...
public class Spam extends ContentAbstract {
	...
	protected Collection getMessages(MsgObject msgObject, Keyword keyword)
		...
		String dbcontent = "dangky_heniken";
	...
	private static boolean saveClient(String dbcontent, String userid,String info) {
		...
		try {
			...
			String sqlInsert = "INSERT INTO " + dbcontent + "(user_id,info)"
					+ "VALUES(?,?)";
	...
	private static int[] getUserID(String userid, String dtbase) {
		int[] result = new int[2];
		Connection cnn = null;
		PreparedStatement statement = null;
		DBPool dbpool = new DBPool();
		ResultSet rs = null;
		String query = "SELECT id FROM " + dtbase + " WHERE user_id= '"
				+ userid.toUpperCase() + "' ";
		result[0] = 0;
		result[1] = 0;
