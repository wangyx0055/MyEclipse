 ...
 * @version 1.0
 */
public class Nhaccho8x51tructiepnew extends ContentAbstract {

	/* First String */
	private static String dbcontent = "icom_dangky_nhaccho_tructiep";
	private static String urlgpc = "http://ringtunes.vinaphone.com.vn/rbt_prov/prov";
				...
				if (!"".equalsIgnoreCase(resultMusicID[1])) {
					...
					if (giff == true) {
						...
						String musichotsend = findListofMusic(dtbase, userid,
								infoid, lastid, 1)
								+ "Truy cap http://nhipdap.vn/ de lua chon cac bai hat khac.DTHT 1900571566";
