 ...
 * @version 1.0
 */
public class Nhacchotructiep20110824 extends ContentAbstract {
									...
									if (result.equalsIgnoreCase("0")) {
										...
										try {
											...
											if (result4.equalsIgnoreCase("0")) {
												mt1 = "De gui tang thanh cong,ban phai cai dat nhac cho truoc, vui long soan XNNC makiemtra gui 8051 de xac nhan cai dat.";
												saveuser(userid,
														"nhaccho_viettel",
														resultMusicID[1],
														resultMusicID[0],
								...
								try {
									...
									if (result.equalsIgnoreCase("200")) {
										...
										try {
											...
											if (result2.equalsIgnoreCase("0")) {
												mt1 = "De hoan thanh viec cai dat nhac cho soan XNNC makiemtra gui 8051, makiemtra duoc tra ve tu 1221.DTHT 1900571566";
												saveuser(userid,
														"nhaccho_viettel",
														resultMusicID[1],
														resultMusicID[0], "0");
