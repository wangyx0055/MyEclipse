...
public class WappushSDP extends ContentAbstract {
	...
	protected Collection getMessages(MsgObject msgObject, Keyword keyword)
		...
		try {
			...
			String service_idmt = getString(_option, "service_idmt", "1680");
			...
			if (sTokens.length < 2) {
				...
				if (link.startsWith("0")) {
					...
					Util.logger.info("Noi dung tra khach hang:" + nametype
							+ ":" + link.substring(2));
					msgObject.setServiceid(service_idmt);
					...
					msgObject
							.setUsertext("Ma khong ton tai, xin vui long thu lai.DTHT 1900571566");
