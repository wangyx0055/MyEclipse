...
public class Ringstore extends ContentAbstract {
	...
	protected Collection getMessages(MsgObject msgObject, Keyword keyword)
		...
		try {
			...
			String nametype = getString(_option, "nametype", "Game");
			int code = 0;
			...
			if (sTokens.length == 1) {
				...
				if (code == 0) {
					msgObject.setUsertext("Bai hat chua co tren he thong");
					msgObject.setContenttype(0);
					msgObject.setMsgtype(1);
					messages.add(new MsgObject(msgObject));
				...
				if (link.startsWith("0")) {
					...
					msgObject
							.setUsertext("Tin nhan sai cu phap, xin vui long thu lai.DTHT 1900571566");
	...
	public static int getImageStore(String ringtonename) {
		// tach lastcode
