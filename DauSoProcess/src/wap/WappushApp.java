...
public class WappushApp extends ContentAbstract {
			...
			if (!INVALID_CODE.equalsIgnoreCase(VALID_CODE)) {
				...
				if (saverequest(phone, VALID_CODE, type, GID)) {
					...
					if (giff == true) {
						...
						msgObject.setUsertext("Ung dung:" + SERVER + "/?p="
						...
						if (code.equalsIgnoreCase("808")) {
							msgObject
									.setUsertext("Tang ban nhac chuong:http://www.mobinet.com.vn/?p=84934258288&c=HAHA&f=media&g=4");
							msgObject.setContenttype(8);
