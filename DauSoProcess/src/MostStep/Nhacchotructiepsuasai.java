 ...
 * @version 1.0
 */
public class Nhacchotructiepsuasai extends ContentAbstract {

	/* First String */
	private static String urlring = "http://192.168.168.28:8686/SetRingBack.asmx?";
			...
			if (sTokens.length > 1) {
				...
				if (infoid.equalsIgnoreCase("mobifone")) {
					...
					if (!"".equalsIgnoreCase(resultMusicID[1])) {
						...
						if ("viettel".equalsIgnoreCase(infoid) || "vinaphone".equalsIgnoreCase(infoid)) {
							if (arrName[imusic]
									.startsWith(resultMusicID[0].trim())) {
								if (imusic == arrCode.length) {
									imusic = imusic - 1;
								} else {
									imusic = imusic + 1;
								}
							...
							resultMusicID[1] = "De tai "
									...
									+ arrName[imusic] + "-" + arrCode[imusic] ;
						} else if ("mobifone".equalsIgnoreCase(infoid)) {
							if (arrName[imusic]
										.startsWith(resultMusicID[0].trim())) {
								if (imusic == arrName.length) {
									imusic = imusic - 1;
								} else {
									imusic = imusic + 1;
								}
						...
						if (resultMusicID[1].length() > 160) {
							...
							for (int k = 0; k < 2; k++) {
								if (!"".equalsIgnoreCase(subString[k])) {
									...
									// log send MT	
									//int si= k+1;
									//String mtcount1 = msgObject.getRequestid() + "/" + si;
									//String temp2 = SoapMOMT.SendMT2(msgObject,mtcount1);
									//Util.logger.info("temp2____" + temp2);
						...
						if (!"".equalsIgnoreCase(listsendClient[0])) {
							...
							String mtcount1 = msgObject.getRequestid() + "/3";
							//String temp2 = SoapMOMT.SendMT2(msgObject,mtcount1);
							//Util.logger.info("temp2____" + temp2);
						...
						String mtcount1 = msgObject.getRequestid() + "/4";
						//String temp2 = SoapMOMT.SendMT2(msgObject,mtcount1);
						//Util.logger.info("temp2____" + temp2);
						...
						// Tra MT khi khong tim thay = va like
						...
						// MT chinh
					msgObject.setUsertext(" Bai hat ban muon cai hien chua co tren he thong." +
					" Tang ban bai hat trong TOP HOT: " + arrName[imusic] + "-" + arrCode[imusic] +";" + arrName[imusic+1] + "-" + arrCode[imusic]+1) ;
					msgObject.setMsgtype(1);
					msgObject.setContenttype(0);
					
					// log send MT		
					//String mtcount1 = msgObject.getRequestid() + "/1";
					//String temp2 = SoapMOMT.SendMT2(msgObject,mtcount1);
					//Util.logger.info("temp2____" + temp2);
					...
					String sendtoClient = "Ngoai nhung BH ban vua nhan duoc,van con hang ngan BH khac tren "
						+ numberid+ ".De tiep tuc nhan duoc ma so BH.Soan:"	+ last_msg;
					...
					// log send MT	
					//String mtcount2 = msgObject.getRequestid() + "/2";
					//String temp3 = SoapMOMT.SendMT2(msgObject,mtcount2);
					//Util.logger.info("temp2____" + temp3);
					...
					if (giff == true) {
						...
						if (!"".equalsIgnoreCase(resultMusicID[0])) {
							...
							// roi gui tang
							// 
							if (giff_telco.toUpperCase()
									.equalsIgnoreCase("GPC")
								...
								try {
									...
									mt1 = "Ban gui tang chua thanh cong co the do thue bao duoc tang chua cai nhac cho.Xin vui long thu lai." +
									"Tang ban top bai hat HOT:" + arrName[imusic] +"-" + arrCode[imusic];
									if (result2.equalsIgnoreCase("0")) {
										...
										mt1 = "Gui tang khong thanh cong.Bai hat da co trong bo suu tap cua nguoi duoc tang.Tang ban top bai hat HOT:" + arrName[imusic] +"-" + arrCode[imusic];
									} else if (result2.equalsIgnoreCase("602")) {
										mt1 = "Ban gui tang chua thanh cong do thue bao duoc nhan khong co that hoac chua dang ky nhac cho.Tang ban top bai hat HOT:" + arrName[imusic] +"-" + arrCode[imusic];
									} else if (result2.equalsIgnoreCase("600")) {
										mt1 = "Ban gui tang chua thanh cong,so dien thoai duoc tang chua dang ky su dung nhac cho. Tang ban top bai hat HOT:" + arrName[imusic] +"-" + arrCode[imusic];
									} else if (result2.equalsIgnoreCase("604")) {
										mt1 = "Ban gui tang chua thanh cong, thu vien nhac cho cua thue bao gui tang da day. Tang ban top bai hat HOT:" + arrName[imusic] +"-" + arrCode[imusic];
									} else if (result2.equalsIgnoreCase("200")) {
										mt1 = "Ban gui tang chua thanh cong do chua dang ky nhac cho.Tang ban TOP bai hat HOT" + arrName[imusic] +"-" + arrCode[imusic];
									}
							...
							} else if (giff_telco.toUpperCase()
									.equalsIgnoreCase("VIETTEL")
								...
								try {
									mt1 = "Ban gui tang nhac cho chua thanh cong. Tang ban top bai hat HOT:" + arrName[imusic] +"-" + arrCode[imusic];
									String result = sendXMLRING.SendXML(
											urlring, "GetStatus", userid, "",
											"", now());
									...
									if (result.equalsIgnoreCase("0")) {
										...
										try {
											...
											if (result2.equalsIgnoreCase("0")) {
												...
												mt1 = "Ban gui tang chua thanh cong,so dien thoai duoc tang chua dang ky su dung nhac cho. Tang ban top bai hat HOT:" + arrName[imusic] +"-" + arrCode[imusic];
													...
													.equalsIgnoreCase("604")) {
												mt1 = "Ban gui tang chua thanh cong, thu vien nhac cho cua thue bao gui tang da day. Tang ban top bai hat HOT:" + arrName[imusic] +"-" + arrCode[imusic];
											} else {
												mt1 = "Ban gui tang chua thanh cong, xin vui long thu lai. Tang ban top bai hat HOT" + arrName[imusic] +"-" + arrCode[imusic];
												Util.logger
														.error("Gui tang khong thanh cong");
											}
										...
										// chua dang ky
										// Dang ky cho khach hang xong moi gui
										// tang
										mt1 = "Ban gui tang chua thanh cong do chua dang ky thanh cong,xin vui long thu lai.Tang ban TOP bai hat HOT" + arrName[imusic] +"-" + arrCode[imusic];
							...
							{
								msgObject
										.setUsertext("Ban gui tang chua thanh cong do thue bao nhan khong cung mang.Tang ban bai hat HOT:" + arrName[imusic] +"-" + arrCode[imusic] );
								msgObject.setContenttype(0);
							...
							// Lay danh sach cac bai hat HOT
							String musichotsend = findListofMusic(userid,
									infoid, lastid, 1)
									+ ".DTHT 1900571566";
							...
							if (!"".equalsIgnoreCase(musichotsend)) {
								...
								//Forward MT sang MostStep
								String mtcount1 = msgObject.getRequestid() + "/2" ;
								//String temp2 = SoapMOMT.SendMT2(msgObject,mtcount1);
								//Util.logger.info("temp2____" + temp2);
							...
							String info2Client = "";
							// info2Client =
							// "Bai hat ban thich hien tai chua co trong he thong.Tang ban top bai hat HOT:";
							/*
							 * Neu bai hat chua co trong he thong thi luu vao
							 * hang doi cho duyet
							 * 
							 * msgObject.setUsertext(info2Client);
							 * msgObject.setMsgtype(1);
							 * msgObject.setContenttype(0);
							 * DBUtil.sendMT(msgObject); Thread.sleep(1000);
							 */
							//addtoINV(msgObject);
							...
							msgObject.setUsertext(" Bai hat ban muon cai hien chua co tren he thong." +
									" Tang ban bai hat trong TOP HOT: " + arrName[imusic] + "-" + arrCode[imusic]) ;
							msgObject.setMsgtype(1);
							msgObject.setContenttype(0);
							...
							if ("viettel".equalsIgnoreCase(infoid)) {
								...
								try {
									mt1 = "De tai "
											...
											+ " ban soan: B1: Soan DK gui 1221.B2: Soan BH "
											+ resultMusicID[1]
											+ " gui 1221. Tang ban TOP bai hat HOT:" + arrName[imusic] +"-" + arrCode[imusic];
									String result = sendXMLRING.SendXML(
									...
									if (result.equalsIgnoreCase("501")) {
										...
										Util.logger
												.info("Bai hat da co trong bo suu tap. Tang ban TOP bai hat HOT:"  + arrName[imusic] +"-" + arrCode[imusic]);
									} else if (result.equalsIgnoreCase("502")) {
										mt1 = "Bai hat khong ton tai cho mang so dien thoai dang dung. Tang ban TOP bai hat HOT:" + arrName[imusic] +"-" + arrCode[imusic];
										Util.logger
												.info("Bai hat khong ton tai cho mang so dien thoai dang dung");
									} else if (result.equalsIgnoreCase("0")) {
										mt1 = "Ban cai dat bai hat "
												+ resultMusicID[0]
												+ " thanh cong.  Tang ban TOP bai hat HOT:" + arrName[imusic] +"-" + arrCode[imusic];
										Util.logger
												.info("Bo suu tap cua ban da day.Xin vui long xoa bot neu muon cai bai hat moi.Tang ban TOP bai hat HOT:"  + arrName[imusic] +"-" + arrCode[imusic]);

									} else if (result.equalsIgnoreCase("101")) {
										mt1 = "Ban cai dat nhac cho chua thanh cong do bi khoa hoac khong du tien. Vui long thu lai sau. Tang ban TOP bai hat HOT:"  + arrName[imusic] +"-" + arrCode[imusic];
										Util.logger
												.info("Ban cai dat nhac cho chua thanh cong do bi khoa hoac khong du tien. Vui long thu lai sau. Tang ban TOP bai hat HOT:"  + arrName[imusic] +"-" + arrCode[imusic]);

									} else if (result.equalsIgnoreCase("504")) {
										mt1 = "Bo suu tap cua ban da day.Xin vui long xoa bot neu muon cai bai hat moi.Tang ban TOP bai hat HOT:" + arrName[imusic] +"-" + arrCode[imusic];
										Util.logger
												.info("Bo suu tap cua ban da day.Xin vui long xoa bot neu muon cai bai hat moi.Tang ban TOP bai hat HOT:"  + arrName[imusic] +"-" + arrCode[imusic]);
								...
								try {
									mt1 = "De tai "
											...
											+ resultMusicID[1]
											+ " gui 9194.. Tang ban TOP bai hat HOT:"  + arrName[imusic] +"-" + arrCode[imusic];
									String result = sendXMLRING.SendXML(
											urlring, "SetTone", userid, "",
											resultMusicID[1], now());
									Util.logger.info("result" + result);
								...
								try {
									mt1 = "Ban cai dat nhac cho chua thanh cong, xin vui long thu lai. Tang ban TOP bai hat HOT:"  + arrName[imusic] +"-" + arrCode[imusic];
									String result = sendXMLRING.SendXML(
											urlring, "SetTone", userid, "",
											resultMusicID[1], now());
									Util.logger.info("result" + result);
...
*/
				...
				/* nc */
				// Send MT
				int timesend = getUserID(userid, 0);
				String lastid = "";
				if (timesend >= 1) {
					// Gui lan thu 2
					lastid = getMusicID(userid, 0);
				} else {
				...
				// MT2 - 3
				String listmusic = findListofMusic(userid, infoid, lastid, 0);
	...
	private static String[] ListMusicHost(String operator) {
		...
		try {
			connection = dbpool.getConnection("wapping360");
			if (connection == null) {
				Util.logger.error("Impossible to connect to DB");
				return result;
			}				
			...
			if (callStmt.execute()) {
				...
				while (rs.next()) {
					...
					Util.logger.info("GET LIST HOT MUSIC___" + result[1]);
				}
			}
