...
public class SubDovui extends ContentAbstract {
	...
	protected Collection getMessages(MsgObject msgObject, Keyword keyword)
		...
		MLIST = getStringfromHashMap(_option, "mlist", "mlist_dovui_moststep");
		Util.logger.info("mlist: " + MLIST);
		String mtfree = getStringfromHashMap(_option, "mtfree", "74");
		int mtfreeInt = 0;
		mtfreeInt = Integer.parseInt(mtfree);
		String duration = getStringfromHashMap(_option, "duration", "7");
		String sservice = getStringfromHashMap(_option, "service", "MSDOVUI");
		...
		String success = getStringfromHashMap(
				_option,
				"success",
				"Ban da dang ky thanh cong dich vu Do vui.Noi dung se duoc gui den ban hang ngay.Cam on da su dung dich vu.DTHT 1900571566.");
	...
	private String getInfo() {
		...
		try {
			...
			String query = "SELECT content FROM icom_textbase_data  where gameid='dovui'  Order by rand() limit 1;";
