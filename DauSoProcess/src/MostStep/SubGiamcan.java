...
public class SubGiamcan extends ContentAbstract {
	...
	protected Collection getMessages(MsgObject msgObject, Keyword keyword)
		...
		String sservice = getStringfromHashMap(_option, "service", "MSGIAMCAN");
	...
	//	String DBCONTENT ="gateway";
		...
		String success = getStringfromHashMap(
				_option,
				"success",
				"Ban da dang ky thanh cong dich vu Giam can.Noi dung se duoc gui den ban hang ngay.Cam on da su dung dich vu.DTHT 1900571566.");
	...
	private String getInfo() {
		...
		try {
			...
			String query = "SELECT content FROM icom_textbase_data  where gameid='giamcan' and subcode1 =1 and dayid =1";
