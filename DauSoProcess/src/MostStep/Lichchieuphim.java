...
public class Lichchieuphim extends ContentAbstract {
	...
	protected Collection getMessages(MsgObject msgObject, Keyword keyword)
		...
		try {
			...
			Util.logger.info("temp1=____" + temp1);
			...
			String mt = "";
				...
				if (sTokens[1].equalsIgnoreCase("HANOI")) {
					mt = getContent("PHIMHN");
				}

				else if (sTokens[1].equalsIgnoreCase("HCMI")){
					mt = getContent("PHIMHCM");
				}
				else
				{
