...
public class Meovat extends ContentAbstract {
	...
	protected Collection getMessages(MsgObject msgObject, Keyword keyword)
		...
		try {
			...
			String mt = "";
				...
				mt = getContent(gameid, sTokens[1]);
	...
	private static String getContent(String gameid, String subcode) {
		Connection cnn = null;
		...
		try {
			...
			String query = "SELECT CONTENT FROM icom_textbase_data WHERE upper(gameid) ='"
					+ gameid.toUpperCase() + "' and upper(subcode1)='" + subcode.toUpperCase() + "'";
