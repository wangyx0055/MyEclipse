 ...
 * @version 1.0
 */
public class Answer_vovhcm extends ContentAbstract {
	...
	protected Collection getMessages(MsgObject msgObject, Keyword keyword)throws Exception {
		try {			
			...
			String serviceID = msgObject.getServiceid();
				...
				if(commandCode.equalsIgnoreCase("RC") && serviceID.equalsIgnoreCase("8551"))
				{						
					try
						{
						...
						else
						{
							...
							msgObject.setUsertext("Yeu cau khong hop le. De tra loi cau hoi, soan: RC <dap an> gui 8551. DTHT:1900571566.");
							msgObject.setMsgtype(1);
							msgObject.setContenttype(0);
							DBUtil.sendMT(msgObject);
