...
public class vovhnFunwithMusic_DBInsert {
	...
	public int insertvovhnfunwithmusic_answer(String userID, int session) {
		...
		try {
			...
			sqlString = "INSERT INTO vovhnfunwithmusic_answer"				
					+ "( user_id, session_id) "
					+ "VALUES (?,?)";			
	...
	public void UpdateTovovhnfunwithmusic_answer(String User_ID,String stage,String answer, int session) {
		...
		try {
			...
			sqlString = "Update vovhnfunwithmusic_answer"				
