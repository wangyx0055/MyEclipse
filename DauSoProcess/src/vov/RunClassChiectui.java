...
public class RunClassChiectui extends Thread {
	...
	private Hashtable getTime() {
		...
		try {
			...
			String sqlSelect = "SELECT id,current ,start_time, block1, block2, block3, block4, block5, block6,block7,block8,block9,block10, end_time, isprocess,current_times,current_question FROM icom_chiectui_config WHERE active = 1";
