...
public class Daugiahcmtracuu extends ContentAbstract {
	protected Collection getMessages(MsgObject msgObject, Keyword keyword)
		...
		try {
			...
			String info = "Gia dang chiem uu the nam trong khoang $T1 den $T2. De biet muc gia ban muon da co nguoi dat chua, soan: DA  gui 8551";
			int iPhien = 0;
			...
			if (sTokens.length == 1) {
				...
				if (count.equalsIgnoreCase("0")) {
					sMTReturn = "Muc gia ban dua ra chua co ai dat, hay nhanh tay soan: DA giadau gui 8751 de so huu "
							+ sSanpham;
					...
					sMTReturn = "Muc gia ban dua ra da co "
							+ count
							+ "  khach hang dat trung, hay dua ra cac muc gia khac va soan tin DA giadau gui 8751 ";
	...
	private static String countPrice(String phien, String price) {
		...
		DBPool dbpool = new DBPool();
		ResultSet rs = null;
		String query = "select count(*) from daugia_sieurehcm where phien="
