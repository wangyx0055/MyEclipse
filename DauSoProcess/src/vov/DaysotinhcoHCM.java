...
public class DaysotinhcoHCM extends ContentAbstract {
	...
	protected Collection getMessages(MsgObject msgObject, Keyword keyword)
		...
		try {
			...
			String database_customer = "icom_dayso_customerhcm";
			...
			//
			String mtContent = "";
			Hashtable numberDelay = Threaddaysotinhcohcm.lastestnumber.SECRET_NUMBER;
			...
			if (Threaddaysotinhcohcm.lastestnumber.isProcess == 0) {

				// Phien choi chua bat dau
				msgObject
						.setUsertext("Phien choi da ket thuc!! Vui long tro lai phien choi tiep theo vao 15h30 thu 7 hang tuan tren VOV Giao thong 91MHz.DTHT 1900571566.");
				msgObject.setContenttype(0);
				msgObject.setMsgtype(1);
				messages.add(new MsgObject(msgObject));
				return messages;
			} else if ((Threaddaysotinhcohcm.lastestnumber.isProcess == 1)) {
