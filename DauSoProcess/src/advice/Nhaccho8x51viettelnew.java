 ...
 * @version 1.0
 */
public class Nhaccho8x51viettelnew extends ContentAbstract {
		...
		try {
			...
			if (sTokens.length == 2) {
				...
				if (contentid.equalsIgnoreCase("")) {
					...
					mt1 = "Ban can dang ky nhac cho de lay ma kiem tra truoc. Soan tin NC ten bai hat gui 8751";
					Util.logger.info("Ban can dang ky nhac cho de lay ma kiem tra truoc. Soan tin NC ten bai hat gui 8751");
				} else {
					Util.logger.info("contentid="+contentid);
					
					mt1 = "Ban cai dat nhac cho chua thanh cong xin vui long thu lai";
					try {
						...
						if (result.equalsIgnoreCase("0")) {
							if (usergif.equalsIgnoreCase("0"))
								mt1 = Registry(userid, contentid);
							else,
								try {
									mt1="Ban gui tang nhac cho chua thanh cong. Xin vui long thu lai.";
									String msisdn = userid + "|" + usergif;
									String result2 = sendXMLRING.SendXML(
											urlring, "PresentTone", msisdn, "",
											contentid, now());
									Util.logger.info("result PresentTone"
											+ result);
									if (result2.equalsIgnoreCase("0")) {
										mt1="";
										Util.logger.info("Gui tang nhac cho thanh cong");
									} 
							...
							mt1 = "Ma kiem tra khong chinh xac. Xin vui long xac nhan lai";
							Util.logger.info("Ma kiem tra khong chinh xac. Xin vui long xac nhan lai");
						}
