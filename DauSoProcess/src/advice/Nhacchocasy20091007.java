 ...
 * @version 1.0
 */
public class Nhacchocasy20091007 extends ContentAbstract {
				...
				if ("".equalsIgnoreCase(resultMusic[0])) {
					...
					if (!checkSinger(dtbase, singer, infoid)) {
						...
						if ("viettel".equalsIgnoreCase(infoid)) {
							mtret = "Ca sy ban thich chua co trong he thong."
									+ viettelHD
	...
	// Cáº­p nháº­t danh sÃ¡ch cÃ¡c id cá»§a cÃ¡c bÃ i hÃ¡t Ä‘Ã£ gá»­i cho
	// khÃ¡ch hÃ ng.
