 ...
 * @version 1.0
 */
public class InvalidRingtone extends ContentAbstract {
	...
	protected Collection getMessages(MsgObject msgObject, Keyword keyword)
		...
		try {
			...
			// Send MT 
				...
				msgObject.setUsertext("Ban nhan khong dung dau so, soan tin GAG gui 8542 de tai nhac chuong cac bai hat trong SMDH 2010.");
