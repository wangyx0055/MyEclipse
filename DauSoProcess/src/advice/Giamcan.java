	...
	protected Collection getMessages(MsgObject msgObject, Keyword keyword)
		...
		try {
			...
			if ("VIETTEL".equalsIgnoreCase(msgObject.getMobileoperator())
				...
				infoid = "vinaphone";
					...
					|| ("Beeline".equalsIgnoreCase(msgObject
							.getMobileoperator()))) {
				infoid = "beeline";
			} else if (("VNM".equalsIgnoreCase(msgObject.getMobileoperator()))
					) {
				infoid = "beeline";
			} else if ("EVN".equalsIgnoreCase(msgObject
							.getMobileoperator())) {
				infoid = "beeline";
			} else {
				infoid = "other";
			...
			if ("other".equalsIgnoreCase(infoid)) {
				msgObject
						.setUsertext("Hien tai dich vu chua ho tro mang cua ban.Vui long quay tro lai sau.DTHT 1900566571");
