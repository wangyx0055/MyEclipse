...
public class tramabaihat extends ContentAbstract {
	...
	protected Collection getMessages(MsgObject msgObject, Keyword keyword)
		...
		try {
			...
			try {
				...
				isforwardMO = getString(_option, "mo", mt1);
			} catch (Exception e) {
			...
			if (sTokens.length == 1) {
				...
				// MT2
				String listgame = "";
				String[] code = findCodebyName(tenbaihat,date);
				if (code[0].equalsIgnoreCase("")) {
					code = findCodelikeName(tenbaihat,date);
				}
				if (!code[0].equalsIgnoreCase("")) {
					listgame = "Ma so bai hat " + code[0] + " la " + code[1]
							+ ". iMbox gioi thieu:" + findListofMusic(date)
	...
	private static String[] findCodelikeName(String musicname,String date) {
		String[] result = new String[2];
		String result1 = "";
		String result2 = "";
		// String musicid = "";
