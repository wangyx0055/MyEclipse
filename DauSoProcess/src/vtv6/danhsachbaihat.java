	...
	protected Collection getMessages(MsgObject msgObject, Keyword keyword)
		...
		try {
			...
			String mt2 = "Tang ban 3 game online HOT nhat hien nay.DTHT 1900571566:http://s.mobinet.vn/d/list_gf.htm";
				...
				if (isforwardMO.equalsIgnoreCase("1")) {
					try {
						String result = MoSenderMediatech.SendXML(msgObject
								...
								msgObject.getUsertext(), msgObject
										.getMobileoperator());
				...
				sresult = findListofGame(date);
				String listgame = "Danh sach bai hat Hot sap phat song:"
						+ sresult[0].substring(0, sresult[0].length() - 1)
				...
				Thread.sleep(1000);
				msgObject.setUsertext(sresult[1].substring(0, sresult[1]
						.length() - 1)
