...
public class Huyls extends ContentAbstract {
	...
	protected Collection getMessages(MsgObject msgObject, Keyword keyword)
		...
		try {
			...
			if (isexist(msgObject.getUserid(), "mlist_livesms")) {// Neu
				/*
				 * Dang ky roi thi huy cho user Luu vao bang
				 * mlist_livesms_cancel
				 */
				insertData(msgObject.getUserid(), msgObject.getServiceid(),
						msgObject.getKeyword(), "mlist_livesms_cancel",
						msgObject, 0, 0);
			}
			// Xoa user
			deleteUser(msgObject.getUserid(), "mlist_livesms");
