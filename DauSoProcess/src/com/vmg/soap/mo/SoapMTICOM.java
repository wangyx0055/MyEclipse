...
public class SoapMTICOM {

	public static boolean getMessages(MsgObject msgObject, String total, String index, String ismore)
		...
		while (iRetries > 0) {
			try {
				...
				url = url
						...
						+ ismore
						+ "&contenttype="
						+ conttent_type + "&operator=" + operator + "&deskey=0";
