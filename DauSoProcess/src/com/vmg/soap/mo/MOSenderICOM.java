...
public class MOSenderICOM extends MOSender {
	...
	public void setTemplate() {
				...
				super.template = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>"
					...
					+ "<soapenv:Body>"
					+ "<ns1:moReceiverStandard soapenv:encodingStyle=\"http://schemas.xmlsoap.org/soap/encoding/\" xmlns:ns1=\"http://tempuri.org/GetMOData/MOReceiver\">"
					...
					+ "<ns1:Operator xsi:type=\"xsd:string\">$Operator$</ns1:Operator>"
					+ "</ns1:moReceiverStandard>" + "</soapenv:Body>"
					+ "</soapenv:Envelope>";
