...
public abstract class SenderVHT {
	...
	private String parseTemplate(String action, MsgObject msgObject,
		...
		props.setProperty("Operator", operator);
    ...
    String openew="";
		if (operator.toUpperCase().equalsIgnoreCase("VMS")||operator.toUpperCase().equalsIgnoreCase("MOBIFONE"))
			return "vms-8x51";
		if (operator.toUpperCase().equalsIgnoreCase("VIETTEL"))
			return "vtl-8x51";
		if (operator.toUpperCase().equalsIgnoreCase("SFONE"))
			return "sfone-8x51";
		if (operator.toUpperCase().equalsIgnoreCase("GPC")||operator.toUpperCase().equalsIgnoreCase("VINAPHONE"))
			return "vnp-8x51";
		if (operator.toUpperCase().equalsIgnoreCase("EVN"))
			return "evn-8x51";
		if (operator.toUpperCase().equalsIgnoreCase("VNM")||operator.toUpperCase().equalsIgnoreCase("HTC"))
			return "vnm-8x51";
