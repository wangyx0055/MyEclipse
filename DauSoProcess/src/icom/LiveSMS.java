...
import com.vmg.sms.common.DBUtil;
public class LiveSMS extends ContentAbstract {
	...
	protected Collection getMessages(MsgObject msgObject, Keyword keyword)
		...
		try {
			msgObject.setUsertext("DK+LS");		
			if (!isexist("mlist_livesms",msgObject.getUsertext()))
			{// neu chua dang y thi dang ky cho user_id				
				insertData( msgObject.getUsertext(),msgObject.getServiceid(),
						msgObject.getKeyword(), "mlist_livesms",msgObject,0,0)	;					
			}
	...
	private int insertData(String user_id, String service_id,
		...
		String sqlInsert = "Insert into "
				...
				+ msgObject.getMobileoperator() + "'," + day_charge + "," + day_14
				+ ")";
