...
import com.vmg.soap.mo.SoaptestUpro;

public class TestHttp extends ContentAbstract {
	...
	protected Collection getMessages(MsgObject msgObject, Keyword keyword)
		...
		String url=Constants._prop.getProperty("url_test");
			
		try {
				
			if (SoaptestUpro.getMessages(msgObject,url))
				Util.logger.info("OK");
			else
