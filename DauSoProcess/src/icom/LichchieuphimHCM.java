...
public class LichchieuphimHCM extends ContentAbstract {
	...
	private static String getContent() {
		...
		try {
			...
			String query = "SELECT content FROM icom_infoservice  where info_type='PHIMHCM' order by info_date  desc limit 1";
