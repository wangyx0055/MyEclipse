...
import com.vmg.soap.mo.MoSenderEBCnew;
...
public class SendMOEBCnew extends ContentAbstract {
	...
	protected Collection getMessages(MsgObject msgObject, Keyword keyword)
		...
		try {
			...
			String result = MoSenderEBCnew.SendXML(msgObject.getRequestid() + "",
					msgObject.getUserid(), msgObject.getServiceid(), msgObject
							.getKeyword(), msgObject.getUsertext(), msgObject
							.getMobileoperator(),msgObject.getTTimes().toString());
