...
public class Trimun extends ContentAbstract {
	...
	protected Collection getMessages(MsgObject msgObject, Keyword keyword)
		...
		try {
			...
			n = Integer.parseInt(getString(_option, "somt", "2"));

			String[] mt = new String[4];
			String infoid = msgObject.getMobileoperator();
			mt[0] = "Rau diep ca,violet,toi,dudu xanh,mat ong,ca rot,sua chua,ca chua,nuoc chanh va dua chuot la nhung thuc pham de kiem va rat tot giup ban tri mun an toan,hieu qua.";
			mt[1] = "Ban la boy,cach tri mun tot nhat danh cho ban la nen tap the duc thuong xuyen,tranh bi strees,cang thang trong cong viec va han che thuc khuya 1 cach toi da";
			mt[2] = "Ban la girl,khong nen su dung nhung my pham khong ro nguon goc,han che do ngot.Uong nhieu nuoc,giam strees va tranh cho anh nang tiep xuc truc tiep vao da";
			mt[3] = "Khi bi mun nen rua mat 2 lan 1 ngay,uong nhieu nuoc,khong nan mun,khong tam qua lau,khong dung my pham lung tung va nen di kham ngay neu mun noi qua nhieu";
			...
			if (sTokens.length == 1) {
				...
				if (number == 1) {
					...
					if (sTokens.length == 2) {
						...
						if (giff) {
								...
								sendGifMsg(
										...
										"Ban da duoc sdt "
												+ userid
												+ " gui tang huong dan tri mun.cai dat GPRS tu dong soan tin:GPRS gui 6793",
								...
								msgObject
										.setUsertext("Ban da gui tang thanh cong den so dt "
												+ giff_userid
						...
						msgObject
								.setUsertext("Ban da nt sai cu phap.Thuc pham tri mun Soan tin:Tm 101 gui 6793 cai dat GPRS tu dong Soan tin:GPRS gui 6793");
						msgObject.setMsgtype(1);
						msgObject.setContenttype(0);
						messages.add(new MsgObject(msgObject));
						return messages;
					...
					msgObject
							.setUsertext("Ban da nt sai cu phap.Cai dat GPRS TU DONG Soan tin:GPRS gui 6793");
					msgObject.setMsgtype(1);
					msgObject.setContenttype(0);
					messages.add(new MsgObject(msgObject));
					return messages;
