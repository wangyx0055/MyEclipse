...
public class QuatangamnhacBD extends ContentAbstract {
	@Override
	...
	private static boolean saveClient(String userid, String baihat,
		...
		try {
			...
			String sqlInsert = "INSERT INTO quatangamnhacbd( user_id,baihat,loinhan,gift_user,mobile_operator) VALUES ('"
					+ userid
					+ "','"
					+ baihat
					+ "','"
