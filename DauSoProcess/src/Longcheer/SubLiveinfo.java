...
public class SubLiveinfo extends ContentAbstract {
	...
	protected Collection getMessages(MsgObject msgObject, Keyword keyword)
		...
		MLIST = getStringfromHashMap(_option, "mlist", "mlist_truyencuoi");
	...
	private int updateData(String user_id, String service_id,
		...
		DBPool dbpool = new DBPool();
		// long lmilisec = System.currentTimeMillis();
		String sqlInsert = "Update " + mlist + " set duration=duration + "
