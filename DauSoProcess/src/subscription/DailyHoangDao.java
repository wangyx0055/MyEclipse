...
public class DailyHoangDao extends DeliveryManager {
	...
	protected Collection getMessages(String ssid, String option,
		...
		try {
			...
			String INFO_ID = "x";
			String MLIST = "x";
			String CLASSNAME = "DailyHoangDao";
			...
			DBCONTENT = getStringfromHashMap(_option, "dbcontent", "x");
			...
			for (int i = 0; i < arrCung.length; i++) {
				arrInfo[i] = getInfo(DBCONTENT, currDate, arrCung[i]);
				//if (arrInfo[i] == null) {
					//return null;
				//}
