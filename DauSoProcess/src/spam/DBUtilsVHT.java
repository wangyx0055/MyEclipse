...
public class DBUtilsVHT {
	...
	public static boolean deletelistspam(MsgObject msgObject) {
		...
		try {
			...
			String sqlDelete = "DELETE FROM listspam where user='"
					+ msgObject.getUserid() + "'";
	...
	public static String[] checkspam(MsgObject msgObject) throws Exception {
		...
		} else if (operator.toUpperCase().equalsIgnoreCase("EVN")) {
	...
	protected static String[] checkspamBEE(MsgObject msgObject)
			throws Exception {
		String[] sRet = new String[2];
		sRet[0] = "0";
		sRet[1] = "";
		...
		try {
			...
			if (result2.size() > 0) {
				...
				if (icount > 150000) {
					...
					// sRet[1] =
					// "Tin nhan SPAM. Ban khong duoc su dung dich vu qua 150.000d/ngay. Vui long goi 1900561558 de duoc huong dan them";
					sRet[1] = Constants._prop.getProperty(
							"spam.mt." + operator,
							"Ban da vi pham quy dinh chong Spam cua mang BEELINE");
					return sRet;
				}
	...
	protected static String[] checkspamEVN(MsgObject msgObject)
			throws Exception {
		String[] sRet = new String[2];
		sRet[0] = "0";
		sRet[1] = "";
		...
		try {
			...
			if (result2.size() > 0) {
				...
				if (icount > 150000) {
					...
					sRet[1] = Constants._prop.getProperty(
							"spam.mt." + operator,
							"Ban da vi pham quy dinh chong Spam cua mang EVN");
					return sRet;
				}
	...
	protected static String[] checkspamGPC(MsgObject msgObject)
			throws Exception {
	...
	private static String[] checkspamindbbycountGPC(String user_id,
			String operator) {
	...
	protected static String[] checkspamSFONE(MsgObject msgObject)
			throws Exception {
		String[] sRet = new String[2];
		sRet[0] = "0";
		sRet[1] = "";
	...
	private static String[] checkspamindbbycountSFONE(String user_id,
			String operator) {
	...
	protected static String[] checkspamVIETTEL(MsgObject msgObject)
			throws Exception {
		String[] sRet = new String[2];
		sRet[0] = "0";
		sRet[1] = "";
		...
		try {
			...
			if (result2.size() > 0) {
				...
				if (icount >= 150000) {
					...
					sRet[1] = Constants._prop.getProperty(
							"spam.mt." + operator,
							"Ban da vi pham quy dinh chong Spam cua mang Viettel");
					return sRet;
				}
	...
	protected static String[] checkspamVMS(MsgObject msgObject)
			throws Exception {
		String[] sRet = new String[2];
		sRet[0] = "0";
		sRet[1] = "";
		try {
			return checkspamindbVMS(msgObject.getUserid(), msgObject
					.getMobileoperator());
		} catch (Exception e) {
			Util.logger.error("checkspam:" + e.getMessage());
		}
		...
		try {
			...
			if (result2.size() > 0) {
				...
				if (icount > 150000) {
					...
					sRet[1] = Constants._prop.getProperty(
							"spam.mt." + operator,
							"Ban da vi pham quy dinh chong Spam cua mang MObifone");
					return sRet;
				}
	...
	protected static String[] checkspamVNM(MsgObject msgObject)
			throws Exception {
		// TODO Auto-generated method stub
		String[] sRet = new String[2];
		sRet[0] = "0";
		...
		try {
			...
			if (result2.size() > 0) {
				...
				if (icount > 150000) {
					...
					sRet[1] = Constants._prop.getProperty(
							"spam.mt." + operator,
							"Ban da vi pham quy dinh chong Spam cua mang Vietnammobile");
					return sRet;
				}
