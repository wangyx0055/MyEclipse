...
public class EMSTools
{
	...
	private static ByteBuffer addHeaders2OTAData(ByteBuffer otaData, String mobileOperator, int contentType) throws EMSException
	{
	...
	public static SubmitSM buildSubmitEMSfromBIN(ByteBuffer otaData, String srcAddr, String destAddr, BigDecimal emsId, byte registeredDelivery, int MsgType,
			String sCommand_code, int TotalSegments, BigDecimal RequestID) throws EMSException
	{
	...
	public static Collection buildSubmitEMS(ByteBuffer otaData, String srcAddr, String destAddr, int contentType, BigDecimal emsId, byte registeredDelivery,
			int MsgType, String commandcode) throws EMSException
	{
	...
	// Sfone
	public static Collection buildSubmitEMS(ByteBuffer otaData, String srcAddr, String destAddr, int contentType, BigDecimal emsId, byte registeredDelivery,
			int MsgType, BigDecimal RequestID, String commandcode) throws EMSException
	{
		SubmitSM request = null;
		Vector vRequests = new Vector();
		...
		try
		{
			...
			for (byte i = 1; i <= totalSegments; i++)
			{
				...
				// request.setSfoneChargeFlag((short) 0x0000);
				Logger.info("SMSCTools.buildSubmitSM", "{RequestID=" + RequestID + "}{srcAddr=" + srcAddr + "}{destAddr=" + destAddr + "}{setDestSubaddress="
						+ DestSubAddress + "} {chargeflag=" + chargeflag + "} ");
	...
	// Dalink
	public static SubmitSM buildSubmitDalink(String srcMsg, String srcAddr, String destAddr, BigDecimal emsId, byte registeredDelivery, int MsgType,
			String sCommand_code, int TotalSegments) throws EMSException
	{
		...
		try
		{
			...
			if ((srcAddr.equals("996")) && (MsgType == 0)
					&& ((sCommand_code.equals("XSMN")) || (sCommand_code.equals("XSMT")) || (sCommand_code.equals("XSMN")) || (sCommand_code.equals("XSTD"))))
			{
				MsgType = 4;
			}
	...
	// Banking
	public static SubmitSM buildSubmitBanking(String srcMsg, String srcAddr, String destAddr, BigDecimal emsId, byte registeredDelivery, int MsgType,
			String sCommand_code, int TotalSegments, String RequestID) throws EMSException
	{
		SubmitSM request = new SubmitSM();
		// t Test = new TLV();
	...
	// Banking
	public static SubmitSM buildSubmitDPORT(String srcMsg, String srcAddr, String destAddr, BigDecimal emsId, byte registeredDelivery, int MsgType,
			String sCommand_code, int TotalSegments, String RequestID) throws EMSException
	{
		SubmitSM request = new SubmitSM();
		// t Test = new TLV();
	...
	public static SubmitSM buildSubmit411A(String srcMsg, String srcAddr, String destAddr, BigDecimal emsId, byte registeredDelivery, int MsgType,
			String sCommand_code, int TotalSegments, String RequestID) throws EMSException
	{
		SubmitSM request = new SubmitSM();
		// t Test = new TLV();
	...
	// Dalink VSSA
	public static SubmitSM buildSubmitDalinkVSSA(String srcMsg, String srcAddr, String destAddr, BigDecimal emsId, byte registeredDelivery, int MsgType,
			String sCommand_code, int TotalSegments) throws EMSException
	{
		SubmitSM request = new SubmitSM();
		try
	...
	// Dalink VSSA
	public static SubmitSM buildSubmitMC8000(String srcMsg, String srcAddr, String destAddr, BigDecimal emsId, byte registeredDelivery, int MsgType,
			String sCommand_code, int TotalSegments) throws EMSException
	{
		SubmitSM request = new SubmitSM();
		try
	...
	// KARAOKE
	public static SubmitSM buildSubmitKARAOKE(String srcMsg, String srcAddr, String destAddr, BigDecimal emsId, byte registeredDelivery, int MsgType,
			String sCommand_code, int TotalSegments) throws
	...
	public static Collection buildSubmitEMS(String filename, String srcAddress, String destAddress, int contentType, int MsgType, String sCommand_code,
	...
	// / long message text
	public static Collection buildSubmitLongMsg(String strData, String srcAddr, String destAddr, int contentType, BigDecimal emsId, byte registeredDelivery,
			int MsgType, String commandcode) throws EMSException
	{
		SubmitSM request = null;
		Vector vRequests = new Vector();
	...
	// / long message text
	public static Collection buildSubmitOMA(String strData, String srcAddr, String destAddr, int contentType, BigDecimal emsId, byte registeredDelivery,
			int MsgType, String commandcode) throws EMSException
	{
		SubmitSM request = null;
		Vector vRequests = new Vector();
	...
	public static Collection buildSubmitLongMsg2(String strData, String srcAddr, String destAddr, int contentType, BigDecimal emsId, byte registeredDelivery)
			throws EMSException
	{
		SubmitSM request = null;
		Vector vRequests = new Vector();
