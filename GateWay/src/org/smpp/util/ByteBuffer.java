...
public class ByteBuffer extends SmppObject {
	...
	private void appendString0(String string, boolean isCString, String encoding)
		...
		if ((string != null) && (string.length() > 0)) {
			...
			try {
				...
				Logger.verbose("Unsupported encoding exception " + e);
	...
	public void appendCString1(String string) {
		try {
			appendString1(string, true, "X-Gsm7Bit");
		} catch (UnsupportedEncodingException e) {
	...
	private void appendString1(String string, boolean isCString, String encoding)
			throws UnsupportedEncodingException {
		if (string != null && string.length() > 0) {
			byte stringBuf[] = null;
			if (encoding != null)
