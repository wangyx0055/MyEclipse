...
@XmlType(name = "", propOrder = { "userName", "password", "msisdn", "mediaType", "mediaID", "channelType", "price", "requestTime" })
@XmlRootElement(name = "GetLinkMedia")
public class GetLinkMedia
{
