...
@SuppressWarnings(
{"unchecked", "unused"})
public class SmsMessage implements org.apache.axis2.databinding.ADBBean
{
	/*
	 * This type was generated from the piece of schema that had name =
	 * SmsMessage Namespace URI = http://www.csapi.org/schema/parlayx/sms/v2_2
			...
			boolean serializeType) throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException
	{
		...
		if (serializeType)
		{
			...
			{
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":SmsMessage",
						xmlWriter);
			}
			else
			{
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "SmsMessage", xmlWriter);
			}
	...
	{
		if (namespace.equals("http://www.csapi.org/schema/parlayx/sms/v2_2")) { return "ns2"; }
		...
		public static SmsMessage parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception
		{
			...
			try
			{
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null)
				{
					...
					if (fullTypeName != null)
					{
						...
						if (!"SmsMessage".equals(type))
						{
							...
							return (SmsMessage) org.csapi.www.schema.parlayx.sms.notification.v2_2.local.ExtensionMapper
				...
				if (reader.isStartElement() && new javax.xml.namespace.QName("", "senderAddress").equals(reader.getName()))
				{
					...
					object.setSenderAddress(org.apache.axis2.databinding.utils.ConverterUtil.convertToAnyURI(content));
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName("", "smsServiceActivationNumber").equals(reader.getName()))
				{

					nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "nil");
					if ("true".equals(nillableValue) || "1".equals(nillableValue)) { throw new org.apache.axis2.databinding.ADBException(
							"The element: " + "smsServiceActivationNumber" + "  cannot be null"); }
