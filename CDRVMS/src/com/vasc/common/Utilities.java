...
public class Utilities {
  ...
  /**
   * You want to connect to weblogicServer to lookup any object via its JNDI name.
  ...
  public Connection getDBConnection() {
    ...
    try {
      ...
      conn = DriverManager.getConnection(
          "jdbc:oracle:thin:@10.4.5.100:1521:ORA", "smpp", "smpp2004");
    }
    catch (Exception ex) {
  ...
  public DataSource getDataSource(String strDataSourceName) throws
      NamingException {
