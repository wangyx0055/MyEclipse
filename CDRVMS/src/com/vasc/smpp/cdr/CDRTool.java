	...
	public synchronized static void add2CDRFileEx(CDR cdr)
	{
		...
		if ("VMS".equals(cdr.getMobileOperator().toUpperCase()))
		{
			...
			try
			{
				...
				if (i == 0)
				{
					sData = cdr.getUserId() + ":" + sId + ":" + commandCode + ":" + commandCode + ":" + cdr.getUserId() + ":" + cdr.getSubmitDate() + ":"
							+ cdr.getDoneDate() + ":" + messageType + ":" + info;
				}
				else if (i == 1)
				{
					sData = "\r\n" + cdr.getUserId() + ":" + sId + ":" + commandCode + ":" + commandCode + ":" + cdr.getUserId() + ":" + cdr.getSubmitDate()
							+ ":" + cdr.getDoneDate() + ":" + messageType + ":" + info;
				}
