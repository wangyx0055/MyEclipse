...
public class Preference {
    ...
    /**
     * How to bind to the SMSC: transmitter (t), receiver (r) or
    ...
    public static String[] validServiceIds = {
          "996",   "997",   "998",   "19001255",   "19001522",   "19001799",
        "84996", "84997", "84998", "8419001255", "8419001522", "8419001799",
        "04996", "04997", "04998", "0419001255", "0419001522", "0419001799"
    };
    ...
    public static byte registeredDelivery = 0; // Delivery Receipt/report request

    public static byte replaceIfPresentFlag = 0; //This sm is to replace the submitted sm (=0: no, =1: replace, >1: NA)
    public static byte dataCoding = 0;

    public static byte smDefaultMsgId = 0;//SMSC index of a pre-defined message( 0: reserved, 1-254: Allowed values, 255: reserved)


    // If you attempt to receive message, how long will the application wait for data.
...
public static String alert_mobile="84988087935";
    ...
    public static Map prefixMap  = new Hashtable(); //source_address(String) :: prefix (Collection)
    public static Map messageMap = new Hashtable(); //source_address(String) :: message(String)
    ...
    public static void loadProperties(String fileName) throws IOException {
        ...
        if (!strTemp.equalsIgnoreCase("t") &&
            ...
            System.out.println("Wrong value of bind_mode parameter in " +
...
public static boolean isValidServiceNumber(String serviceNum){
  ...
  return false;
    ...
    /*
     * In
     *   text: a string seperate by comma (,)
     * Out
     *   a collection of elements without (between) comma (,)
     */
...
//
//           System.out.println("Contain 997 = " + Preference.sourceAddressList.contains("997"));
