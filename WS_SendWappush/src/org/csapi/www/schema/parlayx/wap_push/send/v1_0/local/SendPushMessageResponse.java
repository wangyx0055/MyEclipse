...
@SuppressWarnings(
{"unchecked", "unused"})
public class SendPushMessageResponse implements org.apache.axis2.databinding.ADBBean
{
	/*
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null)
				{
					...
					if (fullTypeName != null)
					{
						...
						if (!"sendPushMessageResponse".equals(type))
						{
							...
							return (SendPushMessageResponse) org.csapi.www.schema.parlayx.wap_push.send.v1_0.local.ExtensionMapper
