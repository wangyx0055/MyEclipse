...
@SuppressWarnings(
{"unchecked", "unused"})
public class RequestSOAPHeader implements org.apache.axis2.databinding.ADBBean
{
	/*
	...
	public boolean isSpPasswordSpecified()
	{
		return localSpPasswordTracker;
	}
	...
	{
		localSpPasswordTracker = param != null;
	...
	public boolean isOauth_tokenSpecified()
	{
		return localOauth_tokenTracker;
	}
	...
	{
		localOauth_tokenTracker = param != null;
	...
	public boolean isWatcherSpecified()
	{
		return localWatcherTracker;
	}
	...
	{
		localWatcherTracker = param != null;
	...
	public boolean isPresentitySpecified()
	{
		return localPresentityTracker;
	}
	...
	{
		localPresentityTracker = param != null;
	...
	public boolean isPresentidSpecified()
	{
		return localPresentidTracker;
	}
	...
	{
		localPresentidTracker = param != null;
	...
	public boolean isMsgTypeSpecified()
	{
		return localMsgTypeTracker;
	}
	...
	public void setMsgType(int param)
	{
		...
		localMsgTypeTracker = param != java.lang.Integer.MIN_VALUE;
			...
			boolean serializeType) throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException
	{
		...
		if (serializeType)
		{
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0))
			{
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix
						+ ":RequestSOAPHeader", xmlWriter);
			}
			else
			{
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "RequestSOAPHeader", xmlWriter);
			}
		...
		{
			namespace = "http://www.huawei.com.cn/schema/common/v2_1";
			writeStartElement(null, namespace, "oauth_token", xmlWriter);
		...
		{
			namespace = "http://www.huawei.com.cn/schema/common/v2_1";
			writeStartElement(null, namespace, "watcher", xmlWriter);
		...
		{
			namespace = "http://www.huawei.com.cn/schema/common/v2_1";
			writeStartElement(null, namespace, "presentity", xmlWriter);
		...
		{
			namespace = "http://www.huawei.com.cn/schema/common/v2_1";
			writeStartElement(null, namespace, "presentid", xmlWriter);
	...
	{
		if (namespace.equals("http://www.huawei.com.cn/schema/common/v2_1")) { return "ns1"; }
			...
			throws org.apache.axis2.databinding.ADBException
	{
		...
		if (localSpIdTracker)
		{
			elementList.add(new javax.xml.namespace.QName("http://www.huawei.com.cn/schema/common/v2_1", "spId"));
		...
		if (localSpPasswordTracker)
		{
			elementList.add(new javax.xml.namespace.QName("http://www.huawei.com.cn/schema/common/v2_1", "spPassword"));
		...
		if (localServiceIdTracker)
		{
			elementList.add(new javax.xml.namespace.QName("http://www.huawei.com.cn/schema/common/v2_1", "serviceId"));
		...
		if (localTimeStampTracker)
		{
			elementList.add(new javax.xml.namespace.QName("http://www.huawei.com.cn/schema/common/v2_1", "timeStamp"));
		...
		if (localOATracker)
		{
			elementList.add(new javax.xml.namespace.QName("http://www.huawei.com.cn/schema/common/v2_1", "OA"));
		...
		if (localOauth_tokenTracker)
		{
			elementList.add(new javax.xml.namespace.QName("http://www.huawei.com.cn/schema/common/v2_1", "oauth_token"));
		...
		if (localFATracker)
		{
			elementList.add(new javax.xml.namespace.QName("http://www.huawei.com.cn/schema/common/v2_1", "FA"));
		...
		if (localTokenTracker)
		{
			elementList.add(new javax.xml.namespace.QName("http://www.huawei.com.cn/schema/common/v2_1", "token"));
		...
		if (localWatcherTracker)
		{
			elementList.add(new javax.xml.namespace.QName("http://www.huawei.com.cn/schema/common/v2_1", "watcher"));
		...
		if (localPresentityTracker)
		{
			elementList.add(new javax.xml.namespace.QName("http://www.huawei.com.cn/schema/common/v2_1", "presentity"));
		...
		if (localAuthIdTracker)
		{
			elementList.add(new javax.xml.namespace.QName("http://www.huawei.com.cn/schema/common/v2_1", "authId"));
		...
		if (localLinkidTracker)
		{
			elementList.add(new javax.xml.namespace.QName("http://www.huawei.com.cn/schema/common/v2_1", "linkid"));
		...
		if (localPresentidTracker)
		{
			elementList.add(new javax.xml.namespace.QName("http://www.huawei.com.cn/schema/common/v2_1", "presentid"));
		...
		if (localMsgTypeTracker)
		{
			elementList.add(new javax.xml.namespace.QName("http://www.huawei.com.cn/schema/common/v2_1", "msgType"));
		...
		public static RequestSOAPHeader parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception
		{
			...
			try
			{
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName("http://www.huawei.com.cn/schema/common/v2_1", "spId")
								.equals(reader.getName()))
				{
					...
					if ("true".equals(nillableValue) || "1".equals(nillableValue)) { throw new org.apache.axis2.databinding.ADBException(
							"The element: " + "spId" + "  cannot be null"); }
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName("http://www.huawei.com.cn/schema/common/v2_1", "spPassword")
								.equals(reader.getName()))
				{

					nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "nil");
					if ("true".equals(nillableValue) || "1".equals(nillableValue)) { throw new org.apache.axis2.databinding.ADBException(
							"The element: " + "spPassword" + "  cannot be null"); }
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName("http://www.huawei.com.cn/schema/common/v2_1", "serviceId")
								.equals(reader.getName()))
				{
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName("http://www.huawei.com.cn/schema/common/v2_1", "timeStamp")
								.equals(reader.getName()))
				{
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName("http://www.huawei.com.cn/schema/common/v2_1", "OA").equals(reader
								.getName()))
				{

					nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "nil");
					if ("true".equals(nillableValue) || "1".equals(nillableValue)) { throw new org.apache.axis2.databinding.ADBException(
							"The element: " + "OA" + "  cannot be null"); }

					java.lang.String content = reader.getElementText();

					object.setOA(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(content));
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName("http://www.huawei.com.cn/schema/common/v2_1", "oauth_token")
								.equals(reader.getName()))
				{

					nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "nil");
					if ("true".equals(nillableValue) || "1".equals(nillableValue)) { throw new org.apache.axis2.databinding.ADBException(
							"The element: " + "oauth_token" + "  cannot be null"); }

					java.lang.String content = reader.getElementText();

					object.setOauth_token(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(content));
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName("http://www.huawei.com.cn/schema/common/v2_1", "FA").equals(reader
								.getName()))
				{

					nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "nil");
					if ("true".equals(nillableValue) || "1".equals(nillableValue)) { throw new org.apache.axis2.databinding.ADBException(
							"The element: " + "FA" + "  cannot be null"); }

					java.lang.String content = reader.getElementText();

					object.setFA(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(content));
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName("http://www.huawei.com.cn/schema/common/v2_1", "token")
								.equals(reader.getName()))
				{
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName("http://www.huawei.com.cn/schema/common/v2_1", "watcher")
								.equals(reader.getName()))
				{

					nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "nil");
					if ("true".equals(nillableValue) || "1".equals(nillableValue)) { throw new org.apache.axis2.databinding.ADBException(
							"The element: " + "watcher" + "  cannot be null"); }

					java.lang.String content = reader.getElementText();

					object.setWatcher(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(content));
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName("http://www.huawei.com.cn/schema/common/v2_1", "presentity")
								.equals(reader.getName()))
				{

					nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "nil");
					if ("true".equals(nillableValue) || "1".equals(nillableValue)) { throw new org.apache.axis2.databinding.ADBException(
							"The element: " + "presentity" + "  cannot be null"); }

					java.lang.String content = reader.getElementText();

					object.setPresentity(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(content));
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName("http://www.huawei.com.cn/schema/common/v2_1", "authId")
								.equals(reader.getName()))
				{

					nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "nil");
					if ("true".equals(nillableValue) || "1".equals(nillableValue)) { throw new org.apache.axis2.databinding.ADBException(
							"The element: " + "authId" + "  cannot be null"); }
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName("http://www.huawei.com.cn/schema/common/v2_1", "linkid")
								.equals(reader.getName()))
				{

					nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "nil");
					if ("true".equals(nillableValue) || "1".equals(nillableValue)) { throw new org.apache.axis2.databinding.ADBException(
							"The element: " + "linkid" + "  cannot be null"); }
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName("http://www.huawei.com.cn/schema/common/v2_1", "presentid")
								.equals(reader.getName()))
				{

					nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "nil");
					if ("true".equals(nillableValue) || "1".equals(nillableValue)) { throw new org.apache.axis2.databinding.ADBException(
							"The element: " + "presentid" + "  cannot be null"); }

					java.lang.String content = reader.getElementText();

					object.setPresentid(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(content));
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName("http://www.huawei.com.cn/schema/common/v2_1", "msgType")
								.equals(reader.getName()))
				{

					nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "nil");
					if ("true".equals(nillableValue) || "1".equals(nillableValue)) { throw new org.apache.axis2.databinding.ADBException(
							"The element: " + "msgType" + "  cannot be null"); }
