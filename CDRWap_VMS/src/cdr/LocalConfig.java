...
public class LocalConfig
{
	...
	static String FTP_SERVER = "ftp://10.50.9.248"; // "ftp://abc.xyz.com/"; // port=21 (default)
	...
	public static String CPID = "000066";
	...
	public static boolean loadProperties(String propFile)
	{
		...
		try
		{
			...
			CPID = properties.getProperty("CPID","000066");
			...
			FILE_STORE_LAST_CDR_FILENAME = properties.getProperty("FILE_STORE_LAST_CDR_FILENAME");
			
			PoolName_Data_SQL = properties.getProperty("PoolName_Data_SQL","HBCharging_Local");
			SHORT_CODE = properties.getProperty("SHORT_CODE","040000");
			return true;
