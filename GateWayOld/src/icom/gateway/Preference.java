...
public class Preference
{
	...
	//public static String[] VALID_SERVICEID = { "1546", "9696", "6083", "6183", "6283", "6383", "6483", "6583", "6683", "6783" };
	public static String[] VALID_SERVICEID = { "1566","1546", "9696", "9070", "9170", "9270", "9370", "9470", "9570", "9670", "9770" };

	public static String[] SERVICEID_SPECIAL = {"1566", "1546", "9696" }; // 1368abce121211
	...
	public static void loadProperties(String fileName) throws IOException
	{
		...
		PayLoadUDH = Byte.toString((byte) 0x06) + Byte.toString((byte) 0x05) + Byte.toString((byte) 0x04) + Byte.toString((byte) 0x13)
				+ Byte.toString((byte) 0x88) + Byte.toString((byte) 0x00) + Byte.toString((byte) 0x00);
