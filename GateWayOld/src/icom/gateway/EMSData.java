...
public class EMSData implements Serializable
{
	...
	private String mobile_operator = null; // e.g: GPC, VMS, VIETTEL
	...
	public String getText()
	{
		if ((content_type == Constants.CT_TEXT) && (text != null))
		{
			...
			//linhnc: push bản tin dài sang Vianphoen với content type = 0
...
*/		}
	...
	public boolean isTimeout()
	{
		...
		if (submit_date != null)
		{
			...
			if ((currTime - submit_date.getTime()) > Preference.timeResend)
			{ // timeout
				result = true;
			}
		}
	...
	public boolean isValidUserId()
	{
		...
		if (((userId.startsWith("90") || userId.startsWith("91") || userId.startsWith("98") || userId.startsWith("95") || userId.startsWith("93")
				|| userId.startsWith("94") || userId.startsWith("92")) && userId.length() == 9)
				|| ((userId.startsWith("090") || userId.startsWith("091") || userId.startsWith("098") || userId.startsWith("097") || userId.startsWith("095")
						|| userId.startsWith("093") || userId.startsWith("094") || userId.startsWith("092")) && userId.length() == 10)
				|| ((userId.startsWith("8490") || userId.startsWith("8491") || userId.startsWith("8498") || userId.startsWith("8497")
						|| userId.startsWith("8495") || userId.startsWith("8493") || userId.startsWith("8494") || userId.startsWith("8492")
						|| (userId.startsWith("8496")) || userId.startsWith("096") && userId.length() == 11)))
		{
			return true;
			// TrungDK EVN -> UNKNOWN
		}
	...
	{
		if (content_type >= Constants.CT_VALUE_MIN && content_type <= Constants.CT_VALUE_MAX)
		{
			return true;
		}
		else
