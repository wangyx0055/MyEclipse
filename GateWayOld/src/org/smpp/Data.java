...
public class Data
{
    ...
    public static final int SM_CONV_ABORT_TYPE          = 0x18;  // Recv Msg contains conversation abort (Kore`n CDMA)
    ...
    public static final short OPT_PAR_RAR_SEG_SNUM        = 0x020F;
    ...
    // Sixteen-bit Unicode Transformathon Format, big-endian byte order 
