 ...
 * accomodate the lengths > 127 (they're stored as negative values in byte vars)
 * 31-10-01 ticp@logica.com SAR fields now correctly return values > 127
 * 20-11-01 ticp@logica.com added support for multibyte string encoding for
 * short message
 */
...
public class DeliverSM extends Request {
	...
	// optional parameters
	private TLVShort userMessageReference = new TLVShort(
			Data.OPT_PAR_USER_MSG_REF);
	private TLVShort sourcePort = new TLVShort(Data.OPT_PAR_SRC_PORT);
	// private TLVByte sourceAddrSubunit = new
	// TLVByte(Data.OPT_PAR_SRC_ADDR_SUBUNIT);
	private TLVShort destinationPort = new TLVShort(Data.OPT_PAR_DST_PORT);
	// private TLVByte destAddrSubunit = new
	// TLVByte(Data.OPT_PAR_DST_ADDR_SUBUNIT);
	...
	private TLVOctets messagePayload = new TLVOctets(Data.OPT_PAR_MSG_PAYLOAD,
			Data.OPT_PAR_MSG_PAYLOAD_MIN, Data.OPT_PAR_MSG_PAYLOAD_MAX);
	private TLVByte privacyIndicator = new TLVByte(Data.OPT_PAR_PRIV_IND);
	private TLVOctets callbackNum = new TLVOctets(Data.OPT_PAR_CALLBACK_NUM,
			Data.OPT_PAR_CALLBACK_NUM_MIN, Data.OPT_PAR_CALLBACK_NUM_MAX); // 4-19
	// private TLVByte callbackNumPresInd = new
	// TLVByte(Data.OPT_PAR_CALLBACK_NUM_PRES_IND);
	// private TLVOctets callbackNumAtag = new
	// TLVOctets(Data.OPT_PAR_CALLBACK_NUM_ATAG,Data.OPT_PAR_CALLBACK_NUM_ATAG_MIN,Data.OPT_PAR_CALLBACK_NUM_ATAG_MAX);
	// // 1-65
	private TLVOctets sourceSubaddress = new TLVOctets(
			Data.OPT_PAR_SRC_SUBADDR, Data.OPT_PAR_SRC_SUBADDR_MIN,
			Data.OPT_PAR_SRC_SUBADDR_MAX); // 2-23
	private TLVOctets destSubaddress = new TLVOctets(Data.OPT_PAR_DEST_SUBADDR,
			Data.OPT_PAR_DEST_SUBADDR_MIN, Data.OPT_PAR_DEST_SUBADDR_MAX);
	...
	// private TLVByte msMsgWaitFacilities = new TLVByte(Data.OPT_PAR_MSG_WAIT);
	// // bit mask
	// private TLVByte numberOfMessages = new TLVByte(Data.OPT_PAR_NUM_MSGS);
	// private TLVEmpty alertOnMsgDelivery = new
	// TLVEmpty(Data.OPT_PAR_ALERT_ON_MSG_DELIVERY);
	...
	private TLVShort itsSessionInfo = new TLVShort(
			Data.OPT_PAR_ITS_SESSION_INFO);
	// private TLVByte ussdServiceOp = new TLVByte(Data.OPT_PAR_USSD_SER_OP);

	private TLVOctets networkErrorCode = new TLVOctets(
			Data.OPT_PAR_NW_ERR_CODE, Data.OPT_PAR_NW_ERR_CODE_MIN,
			Data.OPT_PAR_NW_ERR_CODE_MAX); // exactly 3
	private TLVByte messageState = new TLVByte(Data.OPT_PAR_MSG_STATE);
	private TLVString receiptedMessageId = new TLVString(
			Data.OPT_PAR_RECP_MSG_ID, Data.OPT_PAR_RECP_MSG_ID_MIN,
	...
	public void setShortMessageData(ByteBuffer value) throws PDUException,
	...
	// not used in deliver_sm
	// public void setReplaceIfPresentFlag(byte value) { replaceIfPresentFlag =
	// value; }
	...
	public ByteBuffer getShortMessagebuff() {
